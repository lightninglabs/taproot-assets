...
func specificAssetFilter(id asset.ID, anchorPoint wire.OutPoint, amt uint64,
	groupKey *asset.GroupKey) (QueryAssetFilters, error) {
...
func (a *AssetStore) FetchCommitment(ctx context.Context, id asset.ID,
	anchorPoint wire.OutPoint, amt uint64,
	groupKey *asset.GroupKey) (*tarofreighter.AnchoredCommitment, error) {

	filter, err := specificAssetFilter(id, anchorPoint, amt, groupKey)
	if err != nil {

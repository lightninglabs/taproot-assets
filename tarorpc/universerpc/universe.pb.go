...
type UniverseRoot struct {
	...
	// Types that are assignable to Id:
	//	*UniverseRoot_AssetId
	//	*UniverseRoot_GroupKey
	Id isUniverseRoot_Id `protobuf_oneof:"id"`
...
func (m *UniverseRoot) GetId() isUniverseRoot_Id {
	if m != nil {
		return m.Id
	}
	return nil
...
func (x *UniverseRoot) GetAssetId() []byte {
	if x, ok := x.GetId().(*UniverseRoot_AssetId); ok {
		return x.AssetId
	}
	return nil
}

func (x *UniverseRoot) GetGroupKey() []byte {
	if x, ok := x.GetId().(*UniverseRoot_GroupKey); ok {
		return x.GroupKey
	}
	return nil
}
...
type isUniverseRoot_Id interface {
	isUniverseRoot_Id()
}

type UniverseRoot_AssetId struct {
	// The 32-byte asset ID.
	AssetId []byte `protobuf:"bytes,1,opt,name=asset_id,json=assetId,proto3,oneof"`
}

type UniverseRoot_GroupKey struct {
	// The 32-byte asset group key.
	GroupKey []byte `protobuf:"bytes,2,opt,name=group_key,json=groupKey,proto3,oneof"`
}

func (*UniverseRoot_AssetId) isUniverseRoot_Id() {}

func (*UniverseRoot_GroupKey) isUniverseRoot_Id() {}
...
type SyncTarget struct {
	...
	//	*SyncTarget_AssetId
	//	*SyncTarget_GroupKey
	Target isSyncTarget_Target `protobuf_oneof:"target"`
}
...
func (m *SyncTarget) GetTarget() isSyncTarget_Target {
	if m != nil {
		return m.Target
	}
	return nil
...
func (x *SyncTarget) GetAssetId() []byte {
	if x, ok := x.GetTarget().(*SyncTarget_AssetId); ok {
		return x.AssetId
	}
	return nil
}

func (x *SyncTarget) GetGroupKey() []byte {
	if x, ok := x.GetTarget().(*SyncTarget_GroupKey); ok {
		return x.GroupKey
	}
	return nil
}

type isSyncTarget_Target interface {
	isSyncTarget_Target()
}

type SyncTarget_AssetId struct {
	// The asset ID of the asset set to sync.
	AssetId []byte `protobuf:"bytes,3,opt,name=asset_id,json=assetId,proto3,oneof"`
}

type SyncTarget_GroupKey struct {
	// The group key of the asset set to sync.
	GroupKey []byte `protobuf:"bytes,4,opt,name=group_key,json=groupKey,proto3,oneof"`
}

func (*SyncTarget_AssetId) isSyncTarget_Target() {}

func (*SyncTarget_GroupKey) isSyncTarget_Target() {}
...
type SyncedUniverse struct {
	...
	NewAssetRoot *UniverseRoot `protobuf:"bytes,1,opt,name=new_asset_root,json=newAssetRoot,proto3" json:"new_asset_root,omitempty"`
	// The set of new asset leaves that were synced.
	NewAssetLeaves []*AssetLeaf `protobuf:"bytes,2,rep,name=new_asset_leaves,json=newAssetLeaves,proto3" json:"new_asset_leaves,omitempty"`
}
...
var file_universerpc_universe_proto_rawDesc = []byte{
	...
	0x04, 0x0a, 0x02, 0x69, 0x64, 0x22, 0x8b, 0x01, 0x0a, 0x0c, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72,
	0x73, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x1b, 0x0a, 0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4b,
	0x65, 0x79, 0x12, 0x39, 0x0a, 0x0a, 0x6d, 0x73, 0x73, 0x6d, 0x74, 0x5f, 0x72, 0x6f, 0x6f, 0x74,
	...
	0x64, 0x65, 0x52, 0x09, 0x6d, 0x73, 0x73, 0x6d, 0x74, 0x52, 0x6f, 0x6f, 0x74, 0x42, 0x04, 0x0a,
	0x02, 0x69, 0x64, 0x22, 0xca, 0x01, 0x0a, 0x11, 0x41, 0x73, 0x73, 0x65, 0x74, 0x52, 0x6f, 0x6f,
	...
	0x02, 0x69, 0x64, 0x22, 0x4d, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x6f, 0x6f, 0x74,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x0a, 0x61, 0x73, 0x73, 0x65,
	...
	0x72, 0x73, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x52, 0x09, 0x61, 0x73, 0x73, 0x65, 0x74, 0x52, 0x6f,
	0x6f, 0x74, 0x22, 0x3b, 0x0a, 0x08, 0x4f, 0x75, 0x74, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x19,
	...
	0x0a, 0x0a, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x5f, 0x6b, 0x65, 0x79, 0x22, 0x4c, 0x0a, 0x14,
	...
	0x09, 0x61, 0x73, 0x73, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x73, 0x22, 0x58, 0x0a, 0x09, 0x41, 0x73,
	0x73, 0x65, 0x74, 0x4c, 0x65, 0x61, 0x66, 0x12, 0x24, 0x0a, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x74, 0x61, 0x72, 0x6f, 0x72, 0x70, 0x63,
	...
	0x65, 0x79, 0x52, 0x07, 0x6c, 0x65, 0x61, 0x66, 0x4b, 0x65, 0x79, 0x22, 0xf4, 0x01, 0x0a, 0x15,
	0x49, 0x73, 0x73, 0x75, 0x61, 0x6e, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x73,
	...
	0x61, 0x66, 0x22, 0x72, 0x0a, 0x0d, 0x49, 0x73, 0x73, 0x75, 0x61, 0x6e, 0x63, 0x65, 0x50, 0x72,
	...
	0x65, 0x74, 0x4c, 0x65, 0x61, 0x66, 0x22, 0x52, 0x0a, 0x0a, 0x53, 0x79, 0x6e, 0x63, 0x54, 0x61,
	0x72, 0x67, 0x65, 0x74, 0x12, 0x1b, 0x0a, 0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49,
	0x64, 0x12, 0x1d, 0x0a, 0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0c, 0x48, 0x00, 0x52, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4b, 0x65, 0x79,
	0x42, 0x08, 0x0a, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22, 0xaa, 0x01, 0x0a, 0x0b, 0x53,
	...
	0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x22, 0x93, 0x01, 0x0a, 0x0e, 0x53, 0x79, 0x6e, 0x63,
	0x65, 0x64, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x0e, 0x6e, 0x65,
	0x77, 0x5f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01,
	...
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65,
	0x72, 0x70, 0x63, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x4c, 0x65, 0x61, 0x66, 0x52, 0x0e, 0x6e,
	0x65, 0x77, 0x41, 0x73, 0x73, 0x65, 0x74, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x22, 0x56, 0x0a,
	...
	0x65, 0x72, 0x73, 0x65, 0x73, 0x2a, 0x39, 0x0a, 0x10, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73,
	...
	0x32, 0x9c, 0x04, 0x0a, 0x08, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x12, 0x4b, 0x0a,
	...
	0x52, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x49, 0x73, 0x73, 0x75, 0x61, 0x6e, 0x63, 0x65,
	...
	,
	...
	0x70, 0x63, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42,
...
var file_universerpc_universe_proto_depIdxs = []int32{
	2,  // 0: universerpc.UniverseRoot.mssmt_root:type_name -> universerpc.MerkleSumNode
	20, // 1: universerpc.AssetRootResponse.universe_roots:type_name -> universerpc.AssetRootResponse.UniverseRootsEntry
	3,  // 2: universerpc.AssetRootQuery.id:type_name -> universerpc.ID
	4,  // 3: universerpc.QueryRootResponse.asset_root:type_name -> universerpc.UniverseRoot
	8,  // 4: universerpc.AssetKey.op:type_name -> universerpc.Outpoint
	9,  // 5: universerpc.AssetLeafKeyResponse.asset_keys:type_name -> universerpc.AssetKey
	21, // 6: universerpc.AssetLeaf.asset:type_name -> tarorpc.Asset
	11, // 7: universerpc.AssetLeafResponse.leaves:type_name -> universerpc.AssetLeaf
	3,  // 8: universerpc.UniverseKey.id:type_name -> universerpc.ID
	9,  // 9: universerpc.UniverseKey.leaf_key:type_name -> universerpc.AssetKey
	13, // 10: universerpc.IssuanceProofResponse.req:type_name -> universerpc.UniverseKey
	4,  // 11: universerpc.IssuanceProofResponse.universe_root:type_name -> universerpc.UniverseRoot
	11, // 12: universerpc.IssuanceProofResponse.asset_leaf:type_name -> universerpc.AssetLeaf
	13, // 13: universerpc.IssuanceProof.key:type_name -> universerpc.UniverseKey
	11, // 14: universerpc.IssuanceProof.asset_leaf:type_name -> universerpc.AssetLeaf
	0,  // 15: universerpc.SyncRequest.sync_mode:type_name -> universerpc.UniverseSyncMode
	16, // 16: universerpc.SyncRequest.sync_targets:type_name -> universerpc.SyncTarget
	4,  // 17: universerpc.SyncedUniverse.new_asset_root:type_name -> universerpc.UniverseRoot
	11, // 18: universerpc.SyncedUniverse.new_asset_leaves:type_name -> universerpc.AssetLeaf
	18, // 19: universerpc.SyncResponse.synced_universes:type_name -> universerpc.SyncedUniverse
	4,  // 20: universerpc.AssetRootResponse.UniverseRootsEntry.value:type_name -> universerpc.UniverseRoot
	1,  // 21: universerpc.Universe.AssetRoots:input_type -> universerpc.AssetRootRequest
	6,  // 22: universerpc.Universe.QueryAssetRoots:input_type -> universerpc.AssetRootQuery
	3,  // 23: universerpc.Universe.AssetLeafKeys:input_type -> universerpc.ID
	3,  // 24: universerpc.Universe.AssetLeaves:input_type -> universerpc.ID
	13, // 25: universerpc.Universe.QueryIssuanceProof:input_type -> universerpc.UniverseKey
	15, // 26: universerpc.Universe.InsertIssuanceProof:input_type -> universerpc.IssuanceProof
	17, // 27: universerpc.Universe.SyncUniverse:input_type -> universerpc.SyncRequest
	5,  // 28: universerpc.Universe.AssetRoots:output_type -> universerpc.AssetRootResponse
	7,  // 29: universerpc.Universe.QueryAssetRoots:output_type -> universerpc.QueryRootResponse
	10, // 30: universerpc.Universe.AssetLeafKeys:output_type -> universerpc.AssetLeafKeyResponse
	12, // 31: universerpc.Universe.AssetLeaves:output_type -> universerpc.AssetLeafResponse
	14, // 32: universerpc.Universe.QueryIssuanceProof:output_type -> universerpc.IssuanceProofResponse
	14, // 33: universerpc.Universe.InsertIssuanceProof:output_type -> universerpc.IssuanceProofResponse
	19, // 34: universerpc.Universe.SyncUniverse:output_type -> universerpc.SyncResponse
...
func file_universerpc_universe_proto_init() {
	...
	file_universerpc_universe_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*UniverseRoot_AssetId)(nil),
		(*UniverseRoot_GroupKey)(nil),
	}
	...
	file_universerpc_universe_proto_msgTypes[15].OneofWrappers = []interface{}{
		(*SyncTarget_AssetId)(nil),
		(*SyncTarget_GroupKey)(nil),
	}
	type x struct{}

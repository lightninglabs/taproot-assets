...
// asset needs to be provided after the fact.
//
...
func NewSplitCommitment(input *asset.Asset, outPoint wire.OutPoint,
	...
	*SplitCommitment, error) {
	...
	// With all the split assets inserted created and inserted into the
	// split commitment tree, we'll create the root asset. This root asset

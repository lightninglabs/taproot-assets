...
type PriceOracle interface {
	...
	QueryAskPrice(ctx context.Context, assetId *asset.ID,
		...
		assetRateHint fn.Option[rfqmsg.BigIntFixedPoint]) (
...
func (r *RpcPriceOracle) QueryAskPrice(ctx context.Context,
	...
	assetRateHint fn.Option[rfqmsg.BigIntFixedPoint]) (*OracleResponse,
	error) {
	...
	assetRateHint.WhenSome(func(rate rfqmsg.BigIntFixedPoint) {
...
func (m *MockPriceOracle) QueryAskPrice(_ context.Context,
	...
	_ fn.Option[rfqmsg.BigIntFixedPoint]) (*OracleResponse, error) {

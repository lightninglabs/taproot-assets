...
type ManagerCfg struct {
	...
	// ForwardStore provides persistence for RFQ forward events. This is
	// used for edge node accounting. If nil, forward logging is disabled.
...
// QueryForwards retrieves historical RFQ forward records matching the given
...
// CountForwards returns the count of RFQ forward records matching the given
// filters.

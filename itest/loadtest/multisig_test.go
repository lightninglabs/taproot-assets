...
func multisigTest(t *testing.T, ctx context.Context, cfg *Config) {
	...
	firstBatch := itest.MintAssetsConfirmBatch(
	...
	bobTapd.syncToUniverse(ctx, t, aliceTapd, cfg.TestTimeout)
	...
	itest.AssertAddrEvent(t, bobTapd, muSig2Addr, 1, statusCompleted)
	itest.AssertNonInteractiveRecvComplete(t, bobTapd, 1)
	itest.AssertBalanceByID(
	...
	itest.AssertAddrEvent(t, aliceTapd, withdrawAddr, 1, statusCompleted)
	itest.AssertNonInteractiveRecvComplete(t, aliceTapd, 1)
	itest.AssertBalanceByID(
...
func tapCreatePartialSig(t *testing.T, tapd *rpcClient, params *chaincfg.Params,
	vPkt *tappsbt.VPacket, leafToSign txscript.TapLeaf,
...
func (m *muSig2PartialSigner) SignVirtualTx(_ *lndclient.SignDescriptor,
	...
	ctxt, cancel := context.WithTimeout(ctxb, rpcTimeout)
	defer cancel()
...
func signVirtualPacket(t *testing.T, tapd *rpcClient,
...
func deriveKeys(t *testing.T, tapd *rpcClient) (asset.ScriptKey,
	keychain.KeyDescriptor) {
...
func commitVirtualPsbts(t *testing.T, funder *rpcClient, packet *psbt.Packet,
...
func logAndPublish(t *testing.T, tapd *rpcClient, btcPkt *psbt.Packet,

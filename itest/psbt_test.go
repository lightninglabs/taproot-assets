...
func testPsbtMultiVersionSend(t *harnessTest) {
	...
	ConfirmAndAssertOutboundTransferWithOutputs(
		t.t, t.lndHarness.Miner(), sender, send2Resp,
...
func testPsbtInteractiveAltLeafAnchoring(t *harnessTest) {
	...
	ConfirmAndAssertOutboundTransferWithOutputs(
		t.t, t.lndHarness.Miner(), sender, publishResp,
...
func testPsbtInteractiveTapscriptSibling(t *harnessTest) {
	...
	ConfirmAndAssertOutboundTransferWithOutputs(
		t.t, t.lndHarness.Miner(), alice, sendResp,
...
func testPsbtMultiSend(t *harnessTest) {
	...
	numOutputs := 5
	ConfirmAndAssertOutboundTransferWithOutputs(
		t.t, t.lndHarness.Miner(), sender, sendResp,
...
func testMultiInputPsbtSingleAssetID(t *harnessTest) {
	...
	// Mint a single asset.
	rpcAssets := MintAssetsConfirmBatch(
		t.t, t.lndHarness.Miner(), primaryTapd,
		[]*mintrpc.MintAssetRequest{simpleAssets[0]},
	)
	...
	ConfirmAndAssertOutboundTransfer(
		t.t, t.lndHarness.Miner(), primaryTapd, sendResp,
	...
	ConfirmAndAssertOutboundTransferWithOutputs(
		t.t, t.lndHarness.Miner(), secondaryTapd,
		sendResp, genInfo.AssetId,
	...
	numOutputs = 1
	ConfirmAndAssertOutboundTransferWithOutputs(
		t.t, t.lndHarness.Miner(), secondaryTapd, sendResp,
...
func testPsbtLockTimeSend(t *harnessTest) {
	...
	// time lock.
	MineBlocks(t.t, t.lndHarness.Miner(), 4, 0)
	...
	MineBlocks(t.t, t.lndHarness.Miner(), 1, 0)
...
func testPsbtRelativeLockTimeSend(t *harnessTest) {
	...
	MineBlocks(t.t, t.lndHarness.Miner(), 2, 0)

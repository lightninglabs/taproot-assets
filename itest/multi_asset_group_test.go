...
func testMintMultiAssetGroups(t *harnessTest) {
	...
	mintedBatch := MintAssetsConfirmBatch(
		t.t, t.lndHarness.Miner(), t.tapd, complexBatch,
	)
	...
	ConfirmAndAssertOutboundTransfer(
		t.t, t.lndHarness.Miner(), t.tapd, normalGroupSend,
	...
	ConfirmAndAssertOutboundTransfer(
		t.t, t.lndHarness.Miner(), t.tapd, collectGroupSend,
...
func testMintMultiAssetGroupErrors(t *harnessTest) {
	...
	rpcGroupedAssets := MintAssetsConfirmBatch(
		t.t, t.lndHarness.Miner(), t.tapd, multiAssetGroup,
	)

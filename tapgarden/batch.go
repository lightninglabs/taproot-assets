...
// trivial, and a cache previously let the function silently ignore
// its sibling argument on every call after the first, which could
// anchor a batch to the wrong output key on a restart or RBF retry.

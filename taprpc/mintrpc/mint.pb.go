...
type FundBatchRequest struct {
	...
	// The index of an existing change output in anchor_psbt.
	ChangeOutputIndex int32 `protobuf:"varint,7,opt,name=change_output_index,json=changeOutputIndex,proto3" json:"change_output_index,omitempty"`
	// Set when anchor_psbt has no change output.
	NoChangeOutput bool `protobuf:"varint,8,opt,name=no_change_output,json=noChangeOutput,proto3" json:"no_change_output,omitempty"`
	// The supply commitment output in anchor_psbt, when applicable.
	PreCommitOutputIndex *uint32 `protobuf:"varint,9,opt,name=pre_commit_output_index,json=preCommitOutputIndex,proto3,oneof" json:"pre_commit_output_index,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *FundBatchRequest) GetAnchorPsbt() []byte {
	if x != nil {
		return x.AnchorPsbt
	}
	return nil
...
func (x *FundBatchRequest) GetAssetAnchorOutputIndex() uint32 {
	if x != nil {
		return x.AssetAnchorOutputIndex
	}
	return 0
}

func (x *FundBatchRequest) GetChangeOutputIndex() int32 {
	if x != nil {
...
func (x *FundBatchRequest) GetNoChangeOutput() bool {
	if x != nil {
		return x.NoChangeOutput
	}
	return false
}

func (x *FundBatchRequest) GetPreCommitOutputIndex() uint32 {
	if x != nil && x.PreCommitOutputIndex != nil {
		return *x.PreCommitOutputIndex
	}
	return 0
}
...
func (x *PrepareBatchRequest) GetShortResponse() bool {
	if x != nil {
		return x.ShortResponse
	}
	return false
...
type PrepareBatchResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The prepared batch, including the commitment-mutated anchor PSBT.
	Batch         *MintingBatch `protobuf:"bytes,1,opt,name=batch,proto3" json:"batch,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PrepareBatchResponse) GetBatch() *MintingBatch {
	if x != nil {
		return x.Batch
	}
	return nil
...
type FinalizeBatchRequest struct {
	...
	// The externally signed packet returned by PrepareBatch. All non-signing
	// fields must be identical to the prepared packet.
	SignedPsbt    []byte `protobuf:"bytes,5,opt,name=signed_psbt,json=signedPsbt,proto3" json:"signed_psbt,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FinalizeBatchRequest) GetSignedPsbt() []byte {
	if x != nil {
		return x.SignedPsbt
	}
	return nil
...
func (x *SubscribeMintEventsRequest) Reset() {
	*x = SubscribeMintEventsRequest{}
	mi := &file_mintrpc_mint_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SubscribeMintEventsRequest) Descriptor() ([]byte, []int) {
	return file_mintrpc_mint_proto_rawDescGZIP(), []int{19}
}
...
func (x *MintEvent) Reset() {
	*x = MintEvent{}
	mi := &file_mintrpc_mint_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MintEvent) Descriptor() ([]byte, []int) {
	return file_mintrpc_mint_proto_rawDescGZIP(), []int{20}
}
...
const file_mintrpc_mint_proto_rawDesc = "" +
	...
	"\x12group_virtual_psbt\x18\x04 \x01(\tR\x10groupVirtualPsbt\"\xb8\x05\n" +
	"\tMintAsset\x129\n" +
	"\rasset_version\x18\x01 \x01(\x0e2\x14.taprpc.AssetVersionR\fassetVersion\x120\n" +
	"\n" +
	"asset_type\x18\x02 \x01(\x0e2\x11.taprpc.AssetTypeR\tassetType\x12\x12\n" +
	...
	"\x12external_group_key\x18\x0e \x01(\v2\x13.taprpc.ExternalKeyR\x10externalGroupKey\x12:\n" +
	"\x19enable_supply_commitments\x18\x0f \x01(\bR\x17enableSupplyCommitments\"c\n" +
...
var file_mintrpc_mint_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_mintrpc_mint_proto_goTypes = []any{
	...
	(*PrepareBatchRequest)(nil),        // 10: mintrpc.PrepareBatchRequest
	(*PrepareBatchResponse)(nil),       // 11: mintrpc.PrepareBatchResponse
	(*SealBatchRequest)(nil),           // 12: mintrpc.SealBatchRequest
	(*SealBatchResponse)(nil),          // 13: mintrpc.SealBatchResponse
	(*FinalizeBatchRequest)(nil),       // 14: mintrpc.FinalizeBatchRequest
	(*FinalizeBatchResponse)(nil),      // 15: mintrpc.FinalizeBatchResponse
	(*CancelBatchRequest)(nil),         // 16: mintrpc.CancelBatchRequest
	(*CancelBatchResponse)(nil),        // 17: mintrpc.CancelBatchResponse
	(*ListBatchRequest)(nil),           // 18: mintrpc.ListBatchRequest
	(*ListBatchResponse)(nil),          // 19: mintrpc.ListBatchResponse
	(*SubscribeMintEventsRequest)(nil), // 20: mintrpc.SubscribeMintEventsRequest
	(*MintEvent)(nil),                  // 21: mintrpc.MintEvent
	(taprpc.AssetVersion)(0),           // 22: taprpc.AssetVersion
	(taprpc.AssetType)(0),              // 23: taprpc.AssetType
	(*taprpc.AssetMeta)(nil),           // 24: taprpc.AssetMeta
	(*taprpc.KeyDescriptor)(nil),       // 25: taprpc.KeyDescriptor
	(*taprpc.ScriptKey)(nil),           // 26: taprpc.ScriptKey
	(*taprpc.GroupKeyRequest)(nil),     // 27: taprpc.GroupKeyRequest
	(*taprpc.GroupVirtualTx)(nil),      // 28: taprpc.GroupVirtualTx
	(*taprpc.ExternalKey)(nil),         // 29: taprpc.ExternalKey
	(*taprpc.TapscriptFullTree)(nil),   // 30: taprpc.TapscriptFullTree
	(*taprpc.TapBranch)(nil),           // 31: taprpc.TapBranch
	(*taprpc.GroupWitness)(nil),        // 32: taprpc.GroupWitness
}
var file_mintrpc_mint_proto_depIdxs = []int32{
	22, // 0: mintrpc.PendingAsset.asset_version:type_name -> taprpc.AssetVersion
	23, // 1: mintrpc.PendingAsset.asset_type:type_name -> taprpc.AssetType
	24, // 2: mintrpc.PendingAsset.asset_meta:type_name -> taprpc.AssetMeta
	25, // 3: mintrpc.PendingAsset.group_internal_key:type_name -> taprpc.KeyDescriptor
	26, // 4: mintrpc.PendingAsset.script_key:type_name -> taprpc.ScriptKey
	1,  // 5: mintrpc.UnsealedAsset.asset:type_name -> mintrpc.PendingAsset
	27, // 6: mintrpc.UnsealedAsset.group_key_request:type_name -> taprpc.GroupKeyRequest
	28, // 7: mintrpc.UnsealedAsset.group_virtual_tx:type_name -> taprpc.GroupVirtualTx
	22, // 8: mintrpc.MintAsset.asset_version:type_name -> taprpc.AssetVersion
	23, // 9: mintrpc.MintAsset.asset_type:type_name -> taprpc.AssetType
	24, // 10: mintrpc.MintAsset.asset_meta:type_name -> taprpc.AssetMeta
	25, // 11: mintrpc.MintAsset.group_internal_key:type_name -> taprpc.KeyDescriptor
	26, // 12: mintrpc.MintAsset.script_key:type_name -> taprpc.ScriptKey
	29, // 13: mintrpc.MintAsset.external_group_key:type_name -> taprpc.ExternalKey
	...
	30, // 20: mintrpc.FundBatchRequest.full_tree:type_name -> taprpc.TapscriptFullTree
	31, // 21: mintrpc.FundBatchRequest.branch:type_name -> taprpc.TapBranch
	7,  // 22: mintrpc.FundBatchResponse.batch:type_name -> mintrpc.VerboseBatch
	6,  // 23: mintrpc.PrepareBatchResponse.batch:type_name -> mintrpc.MintingBatch
	32, // 24: mintrpc.SealBatchRequest.group_witnesses:type_name -> taprpc.GroupWitness
	6,  // 25: mintrpc.SealBatchResponse.batch:type_name -> mintrpc.MintingBatch
	30, // 26: mintrpc.FinalizeBatchRequest.full_tree:type_name -> taprpc.TapscriptFullTree
	31, // 27: mintrpc.FinalizeBatchRequest.branch:type_name -> taprpc.TapBranch
	6,  // 28: mintrpc.FinalizeBatchResponse.batch:type_name -> mintrpc.MintingBatch
	7,  // 29: mintrpc.ListBatchResponse.batches:type_name -> mintrpc.VerboseBatch
	0,  // 30: mintrpc.MintEvent.batch_state:type_name -> mintrpc.BatchState
	6,  // 31: mintrpc.MintEvent.batch:type_name -> mintrpc.MintingBatch
	4,  // 32: mintrpc.Mint.MintAsset:input_type -> mintrpc.MintAssetRequest
	8,  // 33: mintrpc.Mint.FundBatch:input_type -> mintrpc.FundBatchRequest
	12, // 34: mintrpc.Mint.SealBatch:input_type -> mintrpc.SealBatchRequest
	10, // 35: mintrpc.Mint.PrepareBatch:input_type -> mintrpc.PrepareBatchRequest
	14, // 36: mintrpc.Mint.FinalizeBatch:input_type -> mintrpc.FinalizeBatchRequest
	16, // 37: mintrpc.Mint.CancelBatch:input_type -> mintrpc.CancelBatchRequest
	18, // 38: mintrpc.Mint.ListBatches:input_type -> mintrpc.ListBatchRequest
	20, // 39: mintrpc.Mint.SubscribeMintEvents:input_type -> mintrpc.SubscribeMintEventsRequest
	...
	13, // 42: mintrpc.Mint.SealBatch:output_type -> mintrpc.SealBatchResponse
	11, // 43: mintrpc.Mint.PrepareBatch:output_type -> mintrpc.PrepareBatchResponse
	15, // 44: mintrpc.Mint.FinalizeBatch:output_type -> mintrpc.FinalizeBatchResponse
	17, // 45: mintrpc.Mint.CancelBatch:output_type -> mintrpc.CancelBatchResponse
	19, // 46: mintrpc.Mint.ListBatches:output_type -> mintrpc.ListBatchResponse
	21, // 47: mintrpc.Mint.SubscribeMintEvents:output_type -> mintrpc.MintEvent
...
func file_mintrpc_mint_proto_init() {
	...
	file_mintrpc_mint_proto_msgTypes[13].OneofWrappers = []any{
		(*FinalizeBatchRequest_FullTree)(nil),
		(*FinalizeBatchRequest_Branch)(nil),
	}
	file_mintrpc_mint_proto_msgTypes[17].OneofWrappers = []any{

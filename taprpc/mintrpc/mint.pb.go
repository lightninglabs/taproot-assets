...
type MintAsset struct {
	...
	// The optional root of a tapscript tree that will be used when constructing a
	// new asset group key. This enables future issuance authorized with a script
	// witness. If an external group key is specified, then the V1 scheme of the
	// group key script construction will be used that supports PSBT signing. In
	// that scheme the user-supplied tapscript root will be extended by two levels
	// of tapscript siblings that commit to the group anchor's asset ID. Therefore,
	// this tapscript root will become a branch in a larger tapscript tree and the
	// final tapscript root will differ from the one provided here.

...
type InsertSupplyLeavesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to GroupKey:
	//
	//	*InsertSupplyLeavesRequest_GroupKeyBytes
	//	*InsertSupplyLeavesRequest_GroupKeyStr
	GroupKey       isInsertSupplyLeavesRequest_GroupKey `protobuf_oneof:"group_key"`
	IssuanceLeaves []*SupplyLeafEntry                   `protobuf:"bytes,3,rep,name=issuance_leaves,json=issuanceLeaves,proto3" json:"issuance_leaves,omitempty"`
	BurnLeaves     []*SupplyLeafEntry                   `protobuf:"bytes,4,rep,name=burn_leaves,json=burnLeaves,proto3" json:"burn_leaves,omitempty"`
	IgnoreLeaves   []*SupplyLeafEntry                   `protobuf:"bytes,5,rep,name=ignore_leaves,json=ignoreLeaves,proto3" json:"ignore_leaves,omitempty"`
}

func (x *InsertSupplyLeavesRequest) Reset() {
	*x = InsertSupplyLeavesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsertSupplyLeavesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsertSupplyLeavesRequest) ProtoMessage() {}

func (x *InsertSupplyLeavesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_universerpc_universe_proto_msgTypes[62]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsertSupplyLeavesRequest.ProtoReflect.Descriptor instead.
func (*InsertSupplyLeavesRequest) Descriptor() ([]byte, []int) {
	return file_universerpc_universe_proto_rawDescGZIP(), []int{62}
}

func (m *InsertSupplyLeavesRequest) GetGroupKey() isInsertSupplyLeavesRequest_GroupKey {
	if m != nil {
		return m.GroupKey
	}
	return nil
...
func (x *InsertSupplyLeavesRequest) GetGroupKeyBytes() []byte {
	if x, ok := x.GetGroupKey().(*InsertSupplyLeavesRequest_GroupKeyBytes); ok {
		return x.GroupKeyBytes
	}
	return nil
}

func (x *InsertSupplyLeavesRequest) GetGroupKeyStr() string {
	if x, ok := x.GetGroupKey().(*InsertSupplyLeavesRequest_GroupKeyStr); ok {
		return x.GroupKeyStr
	}
	return ""
}

func (x *InsertSupplyLeavesRequest) GetIssuanceLeaves() []*SupplyLeafEntry {
	if x != nil {
		return x.IssuanceLeaves
	}
	return nil
...
func (x *InsertSupplyLeavesRequest) GetBurnLeaves() []*SupplyLeafEntry {
	if x != nil {
		return x.BurnLeaves
	}
	return nil
...
func (x *InsertSupplyLeavesRequest) GetIgnoreLeaves() []*SupplyLeafEntry {
	if x != nil {
		return x.IgnoreLeaves
	}
	return nil
...
type isInsertSupplyLeavesRequest_GroupKey interface {
	isInsertSupplyLeavesRequest_GroupKey()
}

type InsertSupplyLeavesRequest_GroupKeyBytes struct {
	// The 32-byte asset group key specified as raw bytes (gRPC only).
	GroupKeyBytes []byte `protobuf:"bytes,1,opt,name=group_key_bytes,json=groupKeyBytes,proto3,oneof"`
}

type InsertSupplyLeavesRequest_GroupKeyStr struct {
	// The 32-byte asset group key encoded as hex string (use this for
	// REST).
	GroupKeyStr string `protobuf:"bytes,2,opt,name=group_key_str,json=groupKeyStr,proto3,oneof"`
}

func (*InsertSupplyLeavesRequest_GroupKeyBytes) isInsertSupplyLeavesRequest_GroupKey() {}

func (*InsertSupplyLeavesRequest_GroupKeyStr) isInsertSupplyLeavesRequest_GroupKey() {}

type InsertSupplyLeavesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *InsertSupplyLeavesResponse) Reset() {
	*x = InsertSupplyLeavesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *InsertSupplyLeavesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsertSupplyLeavesResponse) ProtoMessage() {}

func (x *InsertSupplyLeavesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_universerpc_universe_proto_msgTypes[63]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InsertSupplyLeavesResponse.ProtoReflect.Descriptor instead.
func (*InsertSupplyLeavesResponse) Descriptor() ([]byte, []int) {
...
var file_universerpc_universe_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0xc1, 0x02, 0x0a, 0x19, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x53, 0x75, 0x70,
	...
	0x12, 0x45, 0x0a, 0x0f, 0x69, 0x73, 0x73, 0x75, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x6c, 0x65, 0x61,
	0x76, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x75, 0x6e, 0x69, 0x76,
	0x65, 0x72, 0x73, 0x65, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x4c, 0x65,
	0x61, 0x66, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0e, 0x69, 0x73, 0x73, 0x75, 0x61, 0x6e, 0x63,
	0x65, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x12, 0x3d, 0x0a, 0x0b, 0x62, 0x75, 0x72, 0x6e, 0x5f,
	...
	0x79, 0x4c, 0x65, 0x61, 0x66, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x62, 0x75, 0x72, 0x6e,
	0x4c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x12, 0x41, 0x0a, 0x0d, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65,
	0x5f, 0x6c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e,
	0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x75, 0x70, 0x70,
	0x6c, 0x79, 0x4c, 0x65, 0x61, 0x66, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0c, 0x69, 0x67, 0x6e,
	0x6f, 0x72, 0x65, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x42, 0x0b, 0x0a, 0x09, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x5f, 0x6b, 0x65, 0x79, 0x22, 0x1c, 0x0a, 0x1a, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74,
	...
	0x02, 0x32, 0xf6, 0x10, 0x0a, 0x08, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x12, 0x59,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x65, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75,
	...
	0x6d, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x62, 0x0a, 0x11, 0x46,
	0x65, 0x74, 0x63, 0x68, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x12, 0x25, 0x2e, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x72, 0x70, 0x63, 0x2e, 0x46,
	0x65, 0x74, 0x63, 0x68, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72,
	...
	0x62, 0x0a, 0x11, 0x46, 0x65, 0x74, 0x63, 0x68, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x4c, 0x65,
	0x61, 0x76, 0x65, 0x73, 0x12, 0x25, 0x2e, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x72,
	0x70, 0x63, 0x2e, 0x46, 0x65, 0x74, 0x63, 0x68, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x4c, 0x65,
	0x61, 0x76, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x75, 0x6e,
	...
	0x6e, 0x73, 0x65, 0x12, 0x65, 0x0a, 0x12, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x53, 0x75, 0x70,
	0x70, 0x6c, 0x79, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x12, 0x26, 0x2e, 0x75, 0x6e, 0x69, 0x76,
	0x65, 0x72, 0x73, 0x65, 0x72, 0x70, 0x63, 0x2e, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x53, 0x75,
	0x70, 0x70, 0x6c, 0x79, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x27, 0x2e, 0x75, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x72, 0x70, 0x63, 0x2e,
	0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x4c, 0x65, 0x61, 0x76,
...
var file_universerpc_universe_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_universerpc_universe_proto_goTypes = []any{
	...
	(*InsertSupplyLeavesRequest)(nil),         // 67: universerpc.InsertSupplyLeavesRequest
	(*InsertSupplyLeavesResponse)(nil),        // 68: universerpc.InsertSupplyLeavesResponse
	nil,                                       // 69: universerpc.UniverseRoot.AmountsByAssetIdEntry
	nil,                                       // 70: universerpc.AssetRootResponse.UniverseRootsEntry
	(*taprpc.Asset)(nil),                      // 71: taprpc.Asset
	(*taprpc.AssetMeta)(nil),                  // 72: taprpc.AssetMeta
	(*taprpc.GenesisReveal)(nil),              // 73: taprpc.GenesisReveal
	(*taprpc.GroupKeyReveal)(nil),             // 74: taprpc.GroupKeyReveal
	(taprpc.AssetType)(0),                     // 75: taprpc.AssetType
	(*taprpc.AssetOutPoint)(nil),              // 76: taprpc.AssetOutPoint
}
var file_universerpc_universe_proto_depIdxs = []int32{
	...
	71,  // 17: universerpc.AssetLeaf.asset:type_name -> taprpc.Asset
	...
	72,  // 26: universerpc.IssuanceData.meta_reveal:type_name -> taprpc.AssetMeta
	73,  // 27: universerpc.IssuanceData.genesis_reveal:type_name -> taprpc.GenesisReveal
	74,  // 28: universerpc.IssuanceData.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	...
	75,  // 49: universerpc.AssetStatsAsset.asset_type:type_name -> taprpc.AssetType
	...
	76,  // 59: universerpc.IgnoreAssetOutPointRequest.asset_out_point:type_name -> taprpc.AssetOutPoint
	...
	65,  // 72: universerpc.InsertSupplyLeavesRequest.issuance_leaves:type_name -> universerpc.SupplyLeafEntry
	65,  // 73: universerpc.InsertSupplyLeavesRequest.burn_leaves:type_name -> universerpc.SupplyLeafEntry
	65,  // 74: universerpc.InsertSupplyLeavesRequest.ignore_leaves:type_name -> universerpc.SupplyLeafEntry
	10,  // 75: universerpc.AssetRootResponse.UniverseRootsEntry.value:type_name -> universerpc.UniverseRoot
	5,   // 76: universerpc.Universe.MultiverseRoot:input_type -> universerpc.MultiverseRootRequest
	7,   // 77: universerpc.Universe.AssetRoots:input_type -> universerpc.AssetRootRequest
	12,  // 78: universerpc.Universe.QueryAssetRoots:input_type -> universerpc.AssetRootQuery
	14,  // 79: universerpc.Universe.DeleteAssetRoot:input_type -> universerpc.DeleteRootQuery
	18,  // 80: universerpc.Universe.AssetLeafKeys:input_type -> universerpc.AssetLeafKeysRequest
	9,   // 81: universerpc.Universe.AssetLeaves:input_type -> universerpc.ID
	22,  // 82: universerpc.Universe.QueryProof:input_type -> universerpc.UniverseKey
	25,  // 83: universerpc.Universe.InsertProof:input_type -> universerpc.AssetProof
	26,  // 84: universerpc.Universe.PushProof:input_type -> universerpc.PushProofRequest
	28,  // 85: universerpc.Universe.Info:input_type -> universerpc.InfoRequest
	31,  // 86: universerpc.Universe.SyncUniverse:input_type -> universerpc.SyncRequest
	36,  // 87: universerpc.Universe.ListFederationServers:input_type -> universerpc.ListFederationServersRequest
	38,  // 88: universerpc.Universe.AddFederationServer:input_type -> universerpc.AddFederationServerRequest
	40,  // 89: universerpc.Universe.DeleteFederationServer:input_type -> universerpc.DeleteFederationServerRequest
	33,  // 90: universerpc.Universe.UniverseStats:input_type -> universerpc.StatsRequest
	43,  // 91: universerpc.Universe.QueryAssetStats:input_type -> universerpc.AssetStatsQuery
	47,  // 92: universerpc.Universe.QueryEvents:input_type -> universerpc.QueryEventsRequest
	50,  // 93: universerpc.Universe.SetFederationSyncConfig:input_type -> universerpc.SetFederationSyncConfigRequest
	54,  // 94: universerpc.Universe.QueryFederationSyncConfig:input_type -> universerpc.QueryFederationSyncConfigRequest
	56,  // 95: universerpc.Universe.IgnoreAssetOutPoint:input_type -> universerpc.IgnoreAssetOutPointRequest
	58,  // 96: universerpc.Universe.UpdateSupplyCommit:input_type -> universerpc.UpdateSupplyCommitRequest
	60,  // 97: universerpc.Universe.FetchSupplyCommit:input_type -> universerpc.FetchSupplyCommitRequest
	63,  // 98: universerpc.Universe.FetchSupplyLeaves:input_type -> universerpc.FetchSupplyLeavesRequest
	67,  // 99: universerpc.Universe.InsertSupplyLeaves:input_type -> universerpc.InsertSupplyLeavesRequest
	6,   // 100: universerpc.Universe.MultiverseRoot:output_type -> universerpc.MultiverseRootResponse
	11,  // 101: universerpc.Universe.AssetRoots:output_type -> universerpc.AssetRootResponse
	13,  // 102: universerpc.Universe.QueryAssetRoots:output_type -> universerpc.QueryRootResponse
	15,  // 103: universerpc.Universe.DeleteAssetRoot:output_type -> universerpc.DeleteRootResponse
	19,  // 104: universerpc.Universe.AssetLeafKeys:output_type -> universerpc.AssetLeafKeyResponse
	21,  // 105: universerpc.Universe.AssetLeaves:output_type -> universerpc.AssetLeafResponse
	23,  // 106: universerpc.Universe.QueryProof:output_type -> universerpc.AssetProofResponse
	23,  // 107: universerpc.Universe.InsertProof:output_type -> universerpc.AssetProofResponse
	27,  // 108: universerpc.Universe.PushProof:output_type -> universerpc.PushProofResponse
	29,  // 109: universerpc.Universe.Info:output_type -> universerpc.InfoResponse
	34,  // 110: universerpc.Universe.SyncUniverse:output_type -> universerpc.SyncResponse
	37,  // 111: universerpc.Universe.ListFederationServers:output_type -> universerpc.ListFederationServersResponse
	39,  // 112: universerpc.Universe.AddFederationServer:output_type -> universerpc.AddFederationServerResponse
	41,  // 113: universerpc.Universe.DeleteFederationServer:output_type -> universerpc.DeleteFederationServerResponse
	42,  // 114: universerpc.Universe.UniverseStats:output_type -> universerpc.StatsResponse
	46,  // 115: universerpc.Universe.QueryAssetStats:output_type -> universerpc.UniverseAssetStats
	48,  // 116: universerpc.Universe.QueryEvents:output_type -> universerpc.QueryEventsResponse
	51,  // 117: universerpc.Universe.SetFederationSyncConfig:output_type -> universerpc.SetFederationSyncConfigResponse
	55,  // 118: universerpc.Universe.QueryFederationSyncConfig:output_type -> universerpc.QueryFederationSyncConfigResponse
	57,  // 119: universerpc.Universe.IgnoreAssetOutPoint:output_type -> universerpc.IgnoreAssetOutPointResponse
	59,  // 120: universerpc.Universe.UpdateSupplyCommit:output_type -> universerpc.UpdateSupplyCommitResponse
	62,  // 121: universerpc.Universe.FetchSupplyCommit:output_type -> universerpc.FetchSupplyCommitResponse
	66,  // 122: universerpc.Universe.FetchSupplyLeaves:output_type -> universerpc.FetchSupplyLeavesResponse
	68,  // 123: universerpc.Universe.InsertSupplyLeaves:output_type -> universerpc.InsertSupplyLeavesResponse
...
func file_universerpc_universe_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_universerpc_universe_proto_msgTypes[62].Exporter = func(v any, i int) any {
			switch v := v.(*InsertSupplyLeavesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_universerpc_universe_proto_msgTypes[63].Exporter = func(v any, i int) any {
			switch v := v.(*InsertSupplyLeavesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_universerpc_universe_proto_msgTypes[62].OneofWrappers = []any{
		(*InsertSupplyLeavesRequest_GroupKeyBytes)(nil),
		(*InsertSupplyLeavesRequest_GroupKeyStr)(nil),
	}
	type x struct{}

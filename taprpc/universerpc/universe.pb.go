...
type FetchSupplyCommitRequest struct {
	...
	IssuanceLeafKeys [][]byte `protobuf:"bytes,2,rep,name=issuance_leaf_keys,json=issuanceLeafKeys,proto3" json:"issuance_leaf_keys,omitempty"`
	// Optional: A list of burn leaf keys. For each key in this list,
	// the endpoint will generate and return an inclusion proof.
	BurnLeafKeys [][]byte `protobuf:"bytes,3,rep,name=burn_leaf_keys,json=burnLeafKeys,proto3" json:"burn_leaf_keys,omitempty"`
	// Optional: A list of ignore leaf keys. For each key in this list, the
	// endpoint will generate and return an inclusion proof.
	IgnoreLeafKeys [][]byte `protobuf:"bytes,4,rep,name=ignore_leaf_keys,json=ignoreLeafKeys,proto3" json:"ignore_leaf_keys,omitempty"`
}
...
func (x *FetchSupplyCommitRequest) GetGroupKey() []byte {
	if x != nil {
		return x.GroupKey
	}
	return nil
...
type FetchSupplyCommitResponse struct {
	...
	AnchorTxOutIdx         uint32         `protobuf:"varint,2,opt,name=anchor_tx_out_idx,json=anchorTxOutIdx,proto3" json:"anchor_tx_out_idx,omitempty"`
	AnchorTxOutInternalKey []byte         `protobuf:"bytes,3,opt,name=anchor_tx_out_internal_key,json=anchorTxOutInternalKey,proto3" json:"anchor_tx_out_internal_key,omitempty"`
	// The root of the issuance tree for the specified asset.
	IssuanceSubtreeRoot *SupplyCommitSubtreeRoot `protobuf:"bytes,4,opt,name=issuance_subtree_root,json=issuanceSubtreeRoot,proto3" json:"issuance_subtree_root,omitempty"`
	// The root of the burn tree for the specified asset.
	BurnSubtreeRoot *SupplyCommitSubtreeRoot `protobuf:"bytes,5,opt,name=burn_subtree_root,json=burnSubtreeRoot,proto3" json:"burn_subtree_root,omitempty"`
	// The root of the ignore tree for the specified asset.
	IgnoreSubtreeRoot *SupplyCommitSubtreeRoot `protobuf:"bytes,6,opt,name=ignore_subtree_root,json=ignoreSubtreeRoot,proto3" json:"ignore_subtree_root,omitempty"`
	...
	// `issuance_leaf_keys`.
	IssuanceLeafInclusionProofs [][]byte `protobuf:"bytes,7,rep,name=issuance_leaf_inclusion_proofs,json=issuanceLeafInclusionProofs,proto3" json:"issuance_leaf_inclusion_proofs,omitempty"`
	...
	BurnLeafInclusionProofs [][]byte `protobuf:"bytes,8,rep,name=burn_leaf_inclusion_proofs,json=burnLeafInclusionProofs,proto3" json:"burn_leaf_inclusion_proofs,omitempty"`
	// Inclusion proofs for each ignored leaf key provided in the request.
	// Each entry corresponds to the key at the same index in
	// `ignore_leaf_keys`.
	IgnoreLeafInclusionProofs [][]byte `protobuf:"bytes,9,rep,name=ignore_leaf_inclusion_proofs,json=ignoreLeafInclusionProofs,proto3" json:"ignore_leaf_inclusion_proofs,omitempty"`
}
...
var file_universerpc_universe_proto_rawDesc = []byte{
	...
	,
	...
	0x03, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0c, 0x62, 0x75, 0x72, 0x6e, 0x4c, 0x65, 0x61, 0x66, 0x4b,
	0x65, 0x79, 0x73, 0x12, 0x28, 0x0a, 0x10, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x5f, 0x6c, 0x65,
	0x61, 0x66, 0x5f, 0x6b, 0x65, 0x79, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0c, 0x52, 0x0e, 0x69,
	0x67, 0x6e, 0x6f, 0x72, 0x65, 0x4c, 0x65, 0x61, 0x66, 0x4b, 0x65, 0x79, 0x73, 0x22, 0xd6, 0x01,
	...
	0x6e, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x22, 0x99, 0x05, 0x0a, 0x19, 0x46, 0x65, 0x74, 0x63, 0x68,
	0x53, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x50, 0x0a, 0x16, 0x73, 0x75, 0x70, 0x70, 0x6c, 0x79, 0x5f, 0x63,
	0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x01,
	...
	,
	...
	0x6f, 0x74, 0x52, 0x13, 0x69, 0x73, 0x73, 0x75, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x75, 0x62, 0x74,
	0x72, 0x65, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x50, 0x0a, 0x11, 0x62, 0x75, 0x72, 0x6e, 0x5f,
	...
	,
	...
	0xab, 0x0f, 0x0a, 0x08, 0x55, 0x6e, 0x69, 0x76, 0x65, 0x72, 0x73, 0x65, 0x12, 0x59, 0x0a, 0x0e,
...
var file_universerpc_universe_proto_goTypes = []any{
	...
	nil,                                       // 63: universerpc.UniverseRoot.AmountsByAssetIdEntry
	nil,                                       // 64: universerpc.AssetRootResponse.UniverseRootsEntry
...
var file_universerpc_universe_proto_depIdxs = []int32{
	...
	63, // 7: universerpc.UniverseRoot.amounts_by_asset_id:type_name -> universerpc.UniverseRoot.AmountsByAssetIdEntry
	64, // 8: universerpc.AssetRootResponse.universe_roots:type_name -> universerpc.AssetRootResponse.UniverseRootsEntry
	...
	10, // 66: universerpc.AssetRootResponse.UniverseRootsEntry.value:type_name -> universerpc.UniverseRoot
	5,  // 67: universerpc.Universe.MultiverseRoot:input_type -> universerpc.MultiverseRootRequest
	7,  // 68: universerpc.Universe.AssetRoots:input_type -> universerpc.AssetRootRequest
	12, // 69: universerpc.Universe.QueryAssetRoots:input_type -> universerpc.AssetRootQuery
	14, // 70: universerpc.Universe.DeleteAssetRoot:input_type -> universerpc.DeleteRootQuery
	18, // 71: universerpc.Universe.AssetLeafKeys:input_type -> universerpc.AssetLeafKeysRequest
	9,  // 72: universerpc.Universe.AssetLeaves:input_type -> universerpc.ID
	22, // 73: universerpc.Universe.QueryProof:input_type -> universerpc.UniverseKey
	25, // 74: universerpc.Universe.InsertProof:input_type -> universerpc.AssetProof
	26, // 75: universerpc.Universe.PushProof:input_type -> universerpc.PushProofRequest
	28, // 76: universerpc.Universe.Info:input_type -> universerpc.InfoRequest
	31, // 77: universerpc.Universe.SyncUniverse:input_type -> universerpc.SyncRequest
	36, // 78: universerpc.Universe.ListFederationServers:input_type -> universerpc.ListFederationServersRequest
	38, // 79: universerpc.Universe.AddFederationServer:input_type -> universerpc.AddFederationServerRequest
	40, // 80: universerpc.Universe.DeleteFederationServer:input_type -> universerpc.DeleteFederationServerRequest
	33, // 81: universerpc.Universe.UniverseStats:input_type -> universerpc.StatsRequest
	43, // 82: universerpc.Universe.QueryAssetStats:input_type -> universerpc.AssetStatsQuery
	47, // 83: universerpc.Universe.QueryEvents:input_type -> universerpc.QueryEventsRequest
	50, // 84: universerpc.Universe.SetFederationSyncConfig:input_type -> universerpc.SetFederationSyncConfigRequest
	54, // 85: universerpc.Universe.QueryFederationSyncConfig:input_type -> universerpc.QueryFederationSyncConfigRequest
	56, // 86: universerpc.Universe.IgnoreAssetOutPoint:input_type -> universerpc.IgnoreAssetOutPointRequest
	58, // 87: universerpc.Universe.UpdateSupplyCommit:input_type -> universerpc.UpdateSupplyCommitRequest
	60, // 88: universerpc.Universe.FetchSupplyCommit:input_type -> universerpc.FetchSupplyCommitRequest
	6,  // 89: universerpc.Universe.MultiverseRoot:output_type -> universerpc.MultiverseRootResponse
	11, // 90: universerpc.Universe.AssetRoots:output_type -> universerpc.AssetRootResponse
	13, // 91: universerpc.Universe.QueryAssetRoots:output_type -> universerpc.QueryRootResponse
	15, // 92: universerpc.Universe.DeleteAssetRoot:output_type -> universerpc.DeleteRootResponse
	19, // 93: universerpc.Universe.AssetLeafKeys:output_type -> universerpc.AssetLeafKeyResponse
	21, // 94: universerpc.Universe.AssetLeaves:output_type -> universerpc.AssetLeafResponse
	23, // 95: universerpc.Universe.QueryProof:output_type -> universerpc.AssetProofResponse
	23, // 96: universerpc.Universe.InsertProof:output_type -> universerpc.AssetProofResponse
	27, // 97: universerpc.Universe.PushProof:output_type -> universerpc.PushProofResponse
	29, // 98: universerpc.Universe.Info:output_type -> universerpc.InfoResponse
	34, // 99: universerpc.Universe.SyncUniverse:output_type -> universerpc.SyncResponse
	37, // 100: universerpc.Universe.ListFederationServers:output_type -> universerpc.ListFederationServersResponse
	39, // 101: universerpc.Universe.AddFederationServer:output_type -> universerpc.AddFederationServerResponse
	41, // 102: universerpc.Universe.DeleteFederationServer:output_type -> universerpc.DeleteFederationServerResponse
	42, // 103: universerpc.Universe.UniverseStats:output_type -> universerpc.StatsResponse
	46, // 104: universerpc.Universe.QueryAssetStats:output_type -> universerpc.UniverseAssetStats
	48, // 105: universerpc.Universe.QueryEvents:output_type -> universerpc.QueryEventsResponse
	51, // 106: universerpc.Universe.SetFederationSyncConfig:output_type -> universerpc.SetFederationSyncConfigResponse
	55, // 107: universerpc.Universe.QueryFederationSyncConfig:output_type -> universerpc.QueryFederationSyncConfigResponse
	57, // 108: universerpc.Universe.IgnoreAssetOutPoint:output_type -> universerpc.IgnoreAssetOutPointResponse
	59, // 109: universerpc.Universe.UpdateSupplyCommit:output_type -> universerpc.UpdateSupplyCommitResponse
	62, // 110: universerpc.Universe.FetchSupplyCommit:output_type -> universerpc.FetchSupplyCommitResponse

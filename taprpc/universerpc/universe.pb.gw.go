...
func request_Universe_SubscribeSupplyCommitEvents_0(ctx context.Context, marshaler runtime.Marshaler, client UniverseClient, req *http.Request, pathParams map[string]string) (Universe_SubscribeSupplyCommitEventsClient, runtime.ServerMetadata, error) {
	var protoReq SubscribeSupplyCommitEventsRequest
	var metadata runtime.ServerMetadata
	...
	stream, err := client.SubscribeSupplyCommitEvents(ctx, &protoReq)
	if err != nil {
...
func RegisterUniverseHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UniverseServer) error {
	...
	mux.Handle("POST", pattern_Universe_SubscribeSupplyCommitEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterUniverseHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UniverseClient) error {
	...
	mux.Handle("POST", pattern_Universe_SubscribeSupplyCommitEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/universerpc.Universe/SubscribeSupplyCommitEvents", runtime.WithHTTPPathPattern("/v1/taproot-assets/universe/events/supply-commit"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Universe_SubscribeSupplyCommitEvents_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Universe_SubscribeSupplyCommitEvents_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_Universe_SubscribeSupplyCommitEvents_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"v1", "taproot-assets", "universe", "events", "supply-commit"}, ""))
)
...
var (
	...
	forward_Universe_SubscribeSupplyCommitEvents_0 = runtime.ForwardResponseStream
)

...
var file_taprootassets_proto_rawDesc = []byte{
	...
	0x69, 0x76, 0x65, 0x41, 0x73, 0x73, 0x65, 0x74, 0x73, 0x22, 0xae, 0x04, 0x0a, 0x0e, 0x54, 0x72,
	...
	0x19, 0x0a, 0x08, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x07, 0x61, 0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x22, 0x0d, 0x0a, 0x0b, 0x53, 0x74,
	...
	0x6e, 0x74, 0x73, 0x22, 0x60, 0x0a, 0x10, 0x53, 0x65, 0x6e, 0x64, 0x41, 0x73, 0x73, 0x65, 0x74,
	...
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0x85, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x65, 0x76, 0x49, 0x6e,
	...
	0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x56, 0x31, 0x10, 0x02, 0x2a, 0xd0, 0x01, 0x0a, 0x0f, 0x41,
	...
	0x52, 0x45, 0x44, 0x10, 0x03, 0x32, 0xc5, 0x0c, 0x0a, 0x0d, 0x54, 0x61, 0x70, 0x72, 0x6f, 0x6f,
...
var file_taprootassets_proto_depIdxs = []int32{
	...
	13, // 4: taprpc.GroupKeyRequest.external_key:type_name -> taprpc.ExternalKey
	15, // 5: taprpc.GroupVirtualTx.prev_out:type_name -> taprpc.TxOut
	12, // 6: taprpc.GenesisReveal.genesis_base_reveal:type_name -> taprpc.GenesisInfo
	2,  // 7: taprpc.Asset.version:type_name -> taprpc.AssetVersion
	12, // 8: taprpc.Asset.asset_genesis:type_name -> taprpc.GenesisInfo
	18, // 9: taprpc.Asset.asset_group:type_name -> taprpc.AssetGroup
	11, // 10: taprpc.Asset.chain_anchor:type_name -> taprpc.AnchorInfo
	23, // 11: taprpc.Asset.prev_witnesses:type_name -> taprpc.PrevWitness
	21, // 12: taprpc.Asset.decimal_display:type_name -> taprpc.DecimalDisplay
	71, // 13: taprpc.PrevWitness.prev_id:type_name -> taprpc.PrevInputAsset
	24, // 14: taprpc.PrevWitness.split_commitment:type_name -> taprpc.SplitCommitment
	22, // 15: taprpc.SplitCommitment.root_asset:type_name -> taprpc.Asset
	22, // 16: taprpc.ListAssetResponse.assets:type_name -> taprpc.Asset
	22, // 17: taprpc.ManagedUtxo.assets:type_name -> taprpc.Asset
	89, // 18: taprpc.ListUtxosResponse.managed_utxos:type_name -> taprpc.ListUtxosResponse.ManagedUtxosEntry
	0,  // 19: taprpc.AssetHumanReadable.type:type_name -> taprpc.AssetType
	2,  // 20: taprpc.AssetHumanReadable.version:type_name -> taprpc.AssetVersion
	30, // 21: taprpc.GroupedAssets.assets:type_name -> taprpc.AssetHumanReadable
	90, // 22: taprpc.ListGroupsResponse.groups:type_name -> taprpc.ListGroupsResponse.GroupsEntry
	12, // 23: taprpc.AssetBalance.asset_genesis:type_name -> taprpc.GenesisInfo
	91, // 24: taprpc.ListBalancesResponse.asset_balances:type_name -> taprpc.ListBalancesResponse.AssetBalancesEntry
	92, // 25: taprpc.ListBalancesResponse.asset_group_balances:type_name -> taprpc.ListBalancesResponse.AssetGroupBalancesEntry
	40, // 26: taprpc.ListTransfersResponse.transfers:type_name -> taprpc.AssetTransfer
	41, // 27: taprpc.AssetTransfer.inputs:type_name -> taprpc.TransferInput
	43, // 28: taprpc.AssetTransfer.outputs:type_name -> taprpc.TransferOutput
	39, // 29: taprpc.AssetTransfer.anchor_tx_block_hash:type_name -> taprpc.ChainHash
	42, // 30: taprpc.TransferOutput.anchor:type_name -> taprpc.TransferOutputAnchor
	3,  // 31: taprpc.TransferOutput.output_type:type_name -> taprpc.OutputType
	2,  // 32: taprpc.TransferOutput.asset_version:type_name -> taprpc.AssetVersion
	4,  // 33: taprpc.TransferOutput.proof_delivery_status:type_name -> taprpc.ProofDeliveryStatus
	0,  // 34: taprpc.Addr.asset_type:type_name -> taprpc.AssetType
	2,  // 35: taprpc.Addr.asset_version:type_name -> taprpc.AssetVersion
	5,  // 36: taprpc.Addr.address_version:type_name -> taprpc.AddrVersion
	48, // 37: taprpc.QueryAddrResponse.addrs:type_name -> taprpc.Addr
	52, // 38: taprpc.NewAddrRequest.script_key:type_name -> taprpc.ScriptKey
	54, // 39: taprpc.NewAddrRequest.internal_key:type_name -> taprpc.KeyDescriptor
	2,  // 40: taprpc.NewAddrRequest.asset_version:type_name -> taprpc.AssetVersion
	5,  // 41: taprpc.NewAddrRequest.address_version:type_name -> taprpc.AddrVersion
	54, // 42: taprpc.ScriptKey.key_desc:type_name -> taprpc.KeyDescriptor
	53, // 43: taprpc.KeyDescriptor.key_loc:type_name -> taprpc.KeyLocator
	56, // 44: taprpc.TapscriptFullTree.all_leaves:type_name -> taprpc.TapLeaf
	22, // 45: taprpc.DecodedProof.asset:type_name -> taprpc.Asset
	9,  // 46: taprpc.DecodedProof.meta_reveal:type_name -> taprpc.AssetMeta
	20, // 47: taprpc.DecodedProof.genesis_reveal:type_name -> taprpc.GenesisReveal
	19, // 48: taprpc.DecodedProof.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	60, // 49: taprpc.VerifyProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	60, // 50: taprpc.DecodeProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	81, // 51: taprpc.ExportProofRequest.outpoint:type_name -> taprpc.OutPoint
	48, // 52: taprpc.AddrEvent.addr:type_name -> taprpc.Addr
	6,  // 53: taprpc.AddrEvent.status:type_name -> taprpc.AddrEventStatus
	6,  // 54: taprpc.AddrReceivesRequest.filter_status:type_name -> taprpc.AddrEventStatus
	67, // 55: taprpc.AddrReceivesResponse.events:type_name -> taprpc.AddrEvent
	40, // 56: taprpc.SendAssetResponse.transfer:type_name -> taprpc.AssetTransfer
	40, // 57: taprpc.BurnAssetResponse.burn_transfer:type_name -> taprpc.AssetTransfer
	60, // 58: taprpc.BurnAssetResponse.burn_proof:type_name -> taprpc.DecodedProof
	79, // 59: taprpc.ListBurnsResponse.burns:type_name -> taprpc.AssetBurn
	48, // 60: taprpc.ReceiveEvent.address:type_name -> taprpc.Addr
	6,  // 61: taprpc.ReceiveEvent.status:type_name -> taprpc.AddrEventStatus
	8,  // 62: taprpc.SendEvent.parcel_type:type_name -> taprpc.ParcelType
	48, // 63: taprpc.SendEvent.addresses:type_name -> taprpc.Addr
	86, // 64: taprpc.SendEvent.anchor_transaction:type_name -> taprpc.AnchorTransaction
	40, // 65: taprpc.SendEvent.transfer:type_name -> taprpc.AssetTransfer
	81, // 66: taprpc.AnchorTransaction.lnd_locked_utxos:type_name -> taprpc.OutPoint
	81, // 67: taprpc.RegisterTransferRequest.outpoint:type_name -> taprpc.OutPoint
	22, // 68: taprpc.RegisterTransferResponse.registered_asset:type_name -> taprpc.Asset
	27, // 69: taprpc.ListUtxosResponse.ManagedUtxosEntry.value:type_name -> taprpc.ManagedUtxo
	31, // 70: taprpc.ListGroupsResponse.GroupsEntry.value:type_name -> taprpc.GroupedAssets
	34, // 71: taprpc.ListBalancesResponse.AssetBalancesEntry.value:type_name -> taprpc.AssetBalance
	35, // 72: taprpc.ListBalancesResponse.AssetGroupBalancesEntry.value:type_name -> taprpc.AssetGroupBalance
	10, // 73: taprpc.TaprootAssets.ListAssets:input_type -> taprpc.ListAssetRequest
	26, // 74: taprpc.TaprootAssets.ListUtxos:input_type -> taprpc.ListUtxosRequest
	29, // 75: taprpc.TaprootAssets.ListGroups:input_type -> taprpc.ListGroupsRequest
	33, // 76: taprpc.TaprootAssets.ListBalances:input_type -> taprpc.ListBalancesRequest
	37, // 77: taprpc.TaprootAssets.ListTransfers:input_type -> taprpc.ListTransfersRequest
	44, // 78: taprpc.TaprootAssets.StopDaemon:input_type -> taprpc.StopRequest
	46, // 79: taprpc.TaprootAssets.DebugLevel:input_type -> taprpc.DebugLevelRequest
	49, // 80: taprpc.TaprootAssets.QueryAddrs:input_type -> taprpc.QueryAddrRequest
	51, // 81: taprpc.TaprootAssets.NewAddr:input_type -> taprpc.NewAddrRequest
	58, // 82: taprpc.TaprootAssets.DecodeAddr:input_type -> taprpc.DecodeAddrRequest
	68, // 83: taprpc.TaprootAssets.AddrReceives:input_type -> taprpc.AddrReceivesRequest
	59, // 84: taprpc.TaprootAssets.VerifyProof:input_type -> taprpc.ProofFile
	62, // 85: taprpc.TaprootAssets.DecodeProof:input_type -> taprpc.DecodeProofRequest
	64, // 86: taprpc.TaprootAssets.ExportProof:input_type -> taprpc.ExportProofRequest
	65, // 87: taprpc.TaprootAssets.UnpackProofFile:input_type -> taprpc.UnpackProofFileRequest
	70, // 88: taprpc.TaprootAssets.SendAsset:input_type -> taprpc.SendAssetRequest
	76, // 89: taprpc.TaprootAssets.BurnAsset:input_type -> taprpc.BurnAssetRequest
	78, // 90: taprpc.TaprootAssets.ListBurns:input_type -> taprpc.ListBurnsRequest
	73, // 91: taprpc.TaprootAssets.GetInfo:input_type -> taprpc.GetInfoRequest
	75, // 92: taprpc.TaprootAssets.FetchAssetMeta:input_type -> taprpc.FetchAssetMetaRequest
	82, // 93: taprpc.TaprootAssets.SubscribeReceiveEvents:input_type -> taprpc.SubscribeReceiveEventsRequest
	84, // 94: taprpc.TaprootAssets.SubscribeSendEvents:input_type -> taprpc.SubscribeSendEventsRequest
	87, // 95: taprpc.TaprootAssets.RegisterTransfer:input_type -> taprpc.RegisterTransferRequest
	25, // 96: taprpc.TaprootAssets.ListAssets:output_type -> taprpc.ListAssetResponse
	28, // 97: taprpc.TaprootAssets.ListUtxos:output_type -> taprpc.ListUtxosResponse
	32, // 98: taprpc.TaprootAssets.ListGroups:output_type -> taprpc.ListGroupsResponse
	36, // 99: taprpc.TaprootAssets.ListBalances:output_type -> taprpc.ListBalancesResponse
	38, // 100: taprpc.TaprootAssets.ListTransfers:output_type -> taprpc.ListTransfersResponse
	45, // 101: taprpc.TaprootAssets.StopDaemon:output_type -> taprpc.StopResponse
	47, // 102: taprpc.TaprootAssets.DebugLevel:output_type -> taprpc.DebugLevelResponse
	50, // 103: taprpc.TaprootAssets.QueryAddrs:output_type -> taprpc.QueryAddrResponse
	48, // 104: taprpc.TaprootAssets.NewAddr:output_type -> taprpc.Addr
	48, // 105: taprpc.TaprootAssets.DecodeAddr:output_type -> taprpc.Addr
	69, // 106: taprpc.TaprootAssets.AddrReceives:output_type -> taprpc.AddrReceivesResponse
	61, // 107: taprpc.TaprootAssets.VerifyProof:output_type -> taprpc.VerifyProofResponse
	63, // 108: taprpc.TaprootAssets.DecodeProof:output_type -> taprpc.DecodeProofResponse
	59, // 109: taprpc.TaprootAssets.ExportProof:output_type -> taprpc.ProofFile
	66, // 110: taprpc.TaprootAssets.UnpackProofFile:output_type -> taprpc.UnpackProofFileResponse
	72, // 111: taprpc.TaprootAssets.SendAsset:output_type -> taprpc.SendAssetResponse
	77, // 112: taprpc.TaprootAssets.BurnAsset:output_type -> taprpc.BurnAssetResponse
	80, // 113: taprpc.TaprootAssets.ListBurns:output_type -> taprpc.ListBurnsResponse
	74, // 114: taprpc.TaprootAssets.GetInfo:output_type -> taprpc.GetInfoResponse
	9,  // 115: taprpc.TaprootAssets.FetchAssetMeta:output_type -> taprpc.AssetMeta
	83, // 116: taprpc.TaprootAssets.SubscribeReceiveEvents:output_type -> taprpc.ReceiveEvent
	85, // 117: taprpc.TaprootAssets.SubscribeSendEvents:output_type -> taprpc.SendEvent
	88, // 118: taprpc.TaprootAssets.RegisterTransfer:output_type -> taprpc.RegisterTransferResponse

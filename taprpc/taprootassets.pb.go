...
var file_taprootassets_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x40, 0x0a, 0x1d, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
	...
	0x74, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x22, 0xd2, 0x01, 0x0a, 0x0c, 0x52, 0x65, 0x63, 0x65,
	...
	0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x2a, 0x28, 0x0a, 0x09,
	...
	0x45, 0x44, 0x10, 0x04, 0x32, 0x88, 0x0a, 0x0a, 0x0d, 0x54, 0x61, 0x70, 0x72, 0x6f, 0x6f, 0x74,
	...
	0x2e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x42,
...
var file_taprootassets_proto_goTypes = []interface{}{
	...
	(*TapscriptFullTree)(nil),             // 44: taprpc.TapscriptFullTree
	(*TapLeaf)(nil),                       // 45: taprpc.TapLeaf
	(*TapBranch)(nil),                     // 46: taprpc.TapBranch
	(*DecodeAddrRequest)(nil),             // 47: taprpc.DecodeAddrRequest
	(*ProofFile)(nil),                     // 48: taprpc.ProofFile
	(*DecodedProof)(nil),                  // 49: taprpc.DecodedProof
	(*VerifyProofResponse)(nil),           // 50: taprpc.VerifyProofResponse
	(*DecodeProofRequest)(nil),            // 51: taprpc.DecodeProofRequest
	(*DecodeProofResponse)(nil),           // 52: taprpc.DecodeProofResponse
	(*ExportProofRequest)(nil),            // 53: taprpc.ExportProofRequest
	(*AddrEvent)(nil),                     // 54: taprpc.AddrEvent
	(*AddrReceivesRequest)(nil),           // 55: taprpc.AddrReceivesRequest
	(*AddrReceivesResponse)(nil),          // 56: taprpc.AddrReceivesResponse
	(*SendAssetRequest)(nil),              // 57: taprpc.SendAssetRequest
	(*PrevInputAsset)(nil),                // 58: taprpc.PrevInputAsset
	(*SendAssetResponse)(nil),             // 59: taprpc.SendAssetResponse
	(*GetInfoRequest)(nil),                // 60: taprpc.GetInfoRequest
	(*GetInfoResponse)(nil),               // 61: taprpc.GetInfoResponse
	...
	(*OutPoint)(nil),                      // 65: taprpc.OutPoint
	(*SubscribeReceiveEventsRequest)(nil), // 66: taprpc.SubscribeReceiveEventsRequest
	(*ReceiveEvent)(nil),                  // 67: taprpc.ReceiveEvent
	nil,                                   // 68: taprpc.ListUtxosResponse.ManagedUtxosEntry
	nil,                                   // 69: taprpc.ListGroupsResponse.GroupsEntry
	nil,                                   // 70: taprpc.ListBalancesResponse.AssetBalancesEntry
	nil,                                   // 71: taprpc.ListBalancesResponse.AssetGroupBalancesEntry
}
var file_taprootassets_proto_depIdxs = []int32{
	...
	8,  // 2: taprpc.GenesisReveal.genesis_base_reveal:type_name -> taprpc.GenesisInfo
	...
	58, // 8: taprpc.PrevWitness.prev_id:type_name -> taprpc.PrevInputAsset
	...
	68, // 13: taprpc.ListUtxosResponse.managed_utxos:type_name -> taprpc.ListUtxosResponse.ManagedUtxosEntry
	...
	20, // 16: taprpc.GroupedAssets.assets:type_name -> taprpc.AssetHumanReadable
	69, // 17: taprpc.ListGroupsResponse.groups:type_name -> taprpc.ListGroupsResponse.GroupsEntry
	8,  // 18: taprpc.AssetBalance.asset_genesis:type_name -> taprpc.GenesisInfo
	70, // 19: taprpc.ListBalancesResponse.asset_balances:type_name -> taprpc.ListBalancesResponse.AssetBalancesEntry
	71, // 20: taprpc.ListBalancesResponse.asset_group_balances:type_name -> taprpc.ListBalancesResponse.AssetGroupBalancesEntry
	...
	37, // 29: taprpc.QueryAddrResponse.addrs:type_name -> taprpc.Addr
	41, // 30: taprpc.NewAddrRequest.script_key:type_name -> taprpc.ScriptKey
	43, // 31: taprpc.NewAddrRequest.internal_key:type_name -> taprpc.KeyDescriptor
	2,  // 32: taprpc.NewAddrRequest.asset_version:type_name -> taprpc.AssetVersion
	43, // 33: taprpc.ScriptKey.key_desc:type_name -> taprpc.KeyDescriptor
	42, // 34: taprpc.KeyDescriptor.key_loc:type_name -> taprpc.KeyLocator
	45, // 35: taprpc.TapscriptFullTree.all_leaves:type_name -> taprpc.TapLeaf
	12, // 36: taprpc.DecodedProof.asset:type_name -> taprpc.Asset
	5,  // 37: taprpc.DecodedProof.meta_reveal:type_name -> taprpc.AssetMeta
	11, // 38: taprpc.DecodedProof.genesis_reveal:type_name -> taprpc.GenesisReveal
	10, // 39: taprpc.DecodedProof.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	49, // 40: taprpc.VerifyProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	49, // 41: taprpc.DecodeProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	65, // 42: taprpc.ExportProofRequest.outpoint:type_name -> taprpc.OutPoint
	...
	54, // 46: taprpc.AddrReceivesResponse.events:type_name -> taprpc.AddrEvent
	29, // 47: taprpc.SendAssetResponse.transfer:type_name -> taprpc.AssetTransfer
	29, // 48: taprpc.BurnAssetResponse.burn_transfer:type_name -> taprpc.AssetTransfer
	49, // 49: taprpc.BurnAssetResponse.burn_proof:type_name -> taprpc.DecodedProof
	37, // 50: taprpc.ReceiveEvent.address:type_name -> taprpc.Addr
	...
	47, // 65: taprpc.TaprootAssets.DecodeAddr:input_type -> taprpc.DecodeAddrRequest
	55, // 66: taprpc.TaprootAssets.AddrReceives:input_type -> taprpc.AddrReceivesRequest
	48, // 67: taprpc.TaprootAssets.VerifyProof:input_type -> taprpc.ProofFile
	51, // 68: taprpc.TaprootAssets.DecodeProof:input_type -> taprpc.DecodeProofRequest
	53, // 69: taprpc.TaprootAssets.ExportProof:input_type -> taprpc.ExportProofRequest
	57, // 70: taprpc.TaprootAssets.SendAsset:input_type -> taprpc.SendAssetRequest
	63, // 71: taprpc.TaprootAssets.BurnAsset:input_type -> taprpc.BurnAssetRequest
	60, // 72: taprpc.TaprootAssets.GetInfo:input_type -> taprpc.GetInfoRequest
	62, // 73: taprpc.TaprootAssets.FetchAssetMeta:input_type -> taprpc.FetchAssetMetaRequest
	66, // 74: taprpc.TaprootAssets.SubscribeReceiveEvents:input_type -> taprpc.SubscribeReceiveEventsRequest
	...
	56, // 85: taprpc.TaprootAssets.AddrReceives:output_type -> taprpc.AddrReceivesResponse
	50, // 86: taprpc.TaprootAssets.VerifyProof:output_type -> taprpc.VerifyProofResponse
	52, // 87: taprpc.TaprootAssets.DecodeProof:output_type -> taprpc.DecodeProofResponse
	48, // 88: taprpc.TaprootAssets.ExportProof:output_type -> taprpc.ProofFile
	59, // 89: taprpc.TaprootAssets.SendAsset:output_type -> taprpc.SendAssetResponse
	64, // 90: taprpc.TaprootAssets.BurnAsset:output_type -> taprpc.BurnAssetResponse
	61, // 91: taprpc.TaprootAssets.GetInfo:output_type -> taprpc.GetInfoResponse
	5,  // 92: taprpc.TaprootAssets.FetchAssetMeta:output_type -> taprpc.AssetMeta
	67, // 93: taprpc.TaprootAssets.SubscribeReceiveEvents:output_type -> taprpc.ReceiveEvent

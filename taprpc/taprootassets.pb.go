...
var file_taprootassets_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0a, 0x73, 0x75, 0x62, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xed, 0x02,
	...
	0x6f, 0x66, 0x43, 0x6f, 0x75, 0x72, 0x69, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x22, 0x8c, 0x01,
	...
	0x61, 0x64, 0x64, 0x72, 0x73, 0x22, 0x84, 0x02, 0x0a, 0x0e, 0x4e, 0x65, 0x77, 0x41, 0x64, 0x64,
	...
	0x66, 0x43, 0x6f, 0x75, 0x72, 0x69, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x22, 0x73, 0x0a, 0x09,
	...
	0x74, 0x73, 0x22, 0x2f, 0x0a, 0x10, 0x53, 0x65, 0x6e, 0x64, 0x41, 0x73, 0x73, 0x65, 0x74, 0x52,
	...
	0x64, 0x72, 0x73, 0x22, 0x85, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x65, 0x76, 0x49, 0x6e, 0x70, 0x75,
	...
	0x61, 0x69, 0x6e, 0x22, 0x25, 0x0a, 0x23, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	...
	0x45, 0x5f, 0x4f, 0x50, 0x41, 0x51, 0x55, 0x45, 0x10, 0x00, 0x2a, 0xb0, 0x01, 0x0a, 0x0a, 0x4f,
	...
	,
	...
	0x32, 0x96, 0x0a, 0x0a, 0x0d, 0x54, 0x61, 0x70, 0x72, 0x6f, 0x6f, 0x74, 0x41, 0x73, 0x73, 0x65,
...
var file_taprootassets_proto_goTypes = []interface{}{
	...
	(*GroupKeyReveal)(nil),                      // 9: taprpc.GroupKeyReveal
	(*GenesisReveal)(nil),                       // 10: taprpc.GenesisReveal
	(*Asset)(nil),                               // 11: taprpc.Asset
	(*PrevWitness)(nil),                         // 12: taprpc.PrevWitness
	(*SplitCommitment)(nil),                     // 13: taprpc.SplitCommitment
	(*ListAssetResponse)(nil),                   // 14: taprpc.ListAssetResponse
	(*ListUtxosRequest)(nil),                    // 15: taprpc.ListUtxosRequest
	(*ManagedUtxo)(nil),                         // 16: taprpc.ManagedUtxo
	(*ListUtxosResponse)(nil),                   // 17: taprpc.ListUtxosResponse
	(*ListGroupsRequest)(nil),                   // 18: taprpc.ListGroupsRequest
	(*AssetHumanReadable)(nil),                  // 19: taprpc.AssetHumanReadable
	(*GroupedAssets)(nil),                       // 20: taprpc.GroupedAssets
	(*ListGroupsResponse)(nil),                  // 21: taprpc.ListGroupsResponse
	(*ListBalancesRequest)(nil),                 // 22: taprpc.ListBalancesRequest
	(*AssetBalance)(nil),                        // 23: taprpc.AssetBalance
	(*AssetGroupBalance)(nil),                   // 24: taprpc.AssetGroupBalance
	(*ListBalancesResponse)(nil),                // 25: taprpc.ListBalancesResponse
	(*ListTransfersRequest)(nil),                // 26: taprpc.ListTransfersRequest
	(*ListTransfersResponse)(nil),               // 27: taprpc.ListTransfersResponse
	(*AssetTransfer)(nil),                       // 28: taprpc.AssetTransfer
	(*TransferInput)(nil),                       // 29: taprpc.TransferInput
	(*TransferOutputAnchor)(nil),                // 30: taprpc.TransferOutputAnchor
	(*TransferOutput)(nil),                      // 31: taprpc.TransferOutput
	(*StopRequest)(nil),                         // 32: taprpc.StopRequest
	(*StopResponse)(nil),                        // 33: taprpc.StopResponse
	(*DebugLevelRequest)(nil),                   // 34: taprpc.DebugLevelRequest
	(*DebugLevelResponse)(nil),                  // 35: taprpc.DebugLevelResponse
	(*Addr)(nil),                                // 36: taprpc.Addr
	(*QueryAddrRequest)(nil),                    // 37: taprpc.QueryAddrRequest
	(*QueryAddrResponse)(nil),                   // 38: taprpc.QueryAddrResponse
	(*NewAddrRequest)(nil),                      // 39: taprpc.NewAddrRequest
	(*ScriptKey)(nil),                           // 40: taprpc.ScriptKey
	(*KeyLocator)(nil),                          // 41: taprpc.KeyLocator
	(*KeyDescriptor)(nil),                       // 42: taprpc.KeyDescriptor
	(*DecodeAddrRequest)(nil),                   // 43: taprpc.DecodeAddrRequest
	(*ProofFile)(nil),                           // 44: taprpc.ProofFile
	(*DecodedProof)(nil),                        // 45: taprpc.DecodedProof
	(*VerifyProofResponse)(nil),                 // 46: taprpc.VerifyProofResponse
	(*DecodeProofRequest)(nil),                  // 47: taprpc.DecodeProofRequest
	(*DecodeProofResponse)(nil),                 // 48: taprpc.DecodeProofResponse
	(*ExportProofRequest)(nil),                  // 49: taprpc.ExportProofRequest
	...
	(*BurnAssetRequest)(nil),                    // 63: taprpc.BurnAssetRequest
	(*BurnAssetResponse)(nil),                   // 64: taprpc.BurnAssetResponse
	nil,                                         // 65: taprpc.ListUtxosResponse.ManagedUtxosEntry
	nil,                                         // 66: taprpc.ListGroupsResponse.GroupsEntry
	nil,                                         // 67: taprpc.ListBalancesResponse.AssetBalancesEntry
	nil,                                         // 68: taprpc.ListBalancesResponse.AssetGroupBalancesEntry
}
var file_taprootassets_proto_depIdxs = []int32{
	1,  // 0: taprpc.AssetMeta.type:type_name -> taprpc.AssetMetaType
	7,  // 1: taprpc.GenesisReveal.genesis_base_reveal:type_name -> taprpc.GenesisInfo
	0,  // 2: taprpc.GenesisReveal.asset_type:type_name -> taprpc.AssetType
	7,  // 3: taprpc.Asset.asset_genesis:type_name -> taprpc.GenesisInfo
	0,  // 4: taprpc.Asset.asset_type:type_name -> taprpc.AssetType
	8,  // 5: taprpc.Asset.asset_group:type_name -> taprpc.AssetGroup
	6,  // 6: taprpc.Asset.chain_anchor:type_name -> taprpc.AnchorInfo
	12, // 7: taprpc.Asset.prev_witnesses:type_name -> taprpc.PrevWitness
	54, // 8: taprpc.PrevWitness.prev_id:type_name -> taprpc.PrevInputAsset
	13, // 9: taprpc.PrevWitness.split_commitment:type_name -> taprpc.SplitCommitment
	11, // 10: taprpc.SplitCommitment.root_asset:type_name -> taprpc.Asset
	11, // 11: taprpc.ListAssetResponse.assets:type_name -> taprpc.Asset
	11, // 12: taprpc.ManagedUtxo.assets:type_name -> taprpc.Asset
	65, // 13: taprpc.ListUtxosResponse.managed_utxos:type_name -> taprpc.ListUtxosResponse.ManagedUtxosEntry
	0,  // 14: taprpc.AssetHumanReadable.type:type_name -> taprpc.AssetType
	19, // 15: taprpc.GroupedAssets.assets:type_name -> taprpc.AssetHumanReadable
	66, // 16: taprpc.ListGroupsResponse.groups:type_name -> taprpc.ListGroupsResponse.GroupsEntry
	7,  // 17: taprpc.AssetBalance.asset_genesis:type_name -> taprpc.GenesisInfo
	0,  // 18: taprpc.AssetBalance.asset_type:type_name -> taprpc.AssetType
	67, // 19: taprpc.ListBalancesResponse.asset_balances:type_name -> taprpc.ListBalancesResponse.AssetBalancesEntry
	68, // 20: taprpc.ListBalancesResponse.asset_group_balances:type_name -> taprpc.ListBalancesResponse.AssetGroupBalancesEntry
	28, // 21: taprpc.ListTransfersResponse.transfers:type_name -> taprpc.AssetTransfer
	29, // 22: taprpc.AssetTransfer.inputs:type_name -> taprpc.TransferInput
	31, // 23: taprpc.AssetTransfer.outputs:type_name -> taprpc.TransferOutput
	30, // 24: taprpc.TransferOutput.anchor:type_name -> taprpc.TransferOutputAnchor
	2,  // 25: taprpc.TransferOutput.output_type:type_name -> taprpc.OutputType
	0,  // 26: taprpc.Addr.asset_type:type_name -> taprpc.AssetType
	36, // 27: taprpc.QueryAddrResponse.addrs:type_name -> taprpc.Addr
	40, // 28: taprpc.NewAddrRequest.script_key:type_name -> taprpc.ScriptKey
	42, // 29: taprpc.NewAddrRequest.internal_key:type_name -> taprpc.KeyDescriptor
	42, // 30: taprpc.ScriptKey.key_desc:type_name -> taprpc.KeyDescriptor
	41, // 31: taprpc.KeyDescriptor.key_loc:type_name -> taprpc.KeyLocator
	11, // 32: taprpc.DecodedProof.asset:type_name -> taprpc.Asset
	4,  // 33: taprpc.DecodedProof.meta_reveal:type_name -> taprpc.AssetMeta
	10, // 34: taprpc.DecodedProof.genesis_reveal:type_name -> taprpc.GenesisReveal
	9,  // 35: taprpc.DecodedProof.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	45, // 36: taprpc.VerifyProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	45, // 37: taprpc.DecodeProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	36, // 38: taprpc.AddrEvent.addr:type_name -> taprpc.Addr
	3,  // 39: taprpc.AddrEvent.status:type_name -> taprpc.AddrEventStatus
	3,  // 40: taprpc.AddrReceivesRequest.filter_status:type_name -> taprpc.AddrEventStatus
	50, // 41: taprpc.AddrReceivesResponse.events:type_name -> taprpc.AddrEvent
	28, // 42: taprpc.SendAssetResponse.transfer:type_name -> taprpc.AssetTransfer
	60, // 43: taprpc.SendAssetEvent.execute_send_state_event:type_name -> taprpc.ExecuteSendStateEvent
	61, // 44: taprpc.SendAssetEvent.receiver_proof_backoff_wait_event:type_name -> taprpc.ReceiverProofBackoffWaitEvent
	28, // 45: taprpc.BurnAssetResponse.burn_transfer:type_name -> taprpc.AssetTransfer
	45, // 46: taprpc.BurnAssetResponse.burn_proof:type_name -> taprpc.DecodedProof
	16, // 47: taprpc.ListUtxosResponse.ManagedUtxosEntry.value:type_name -> taprpc.ManagedUtxo
	20, // 48: taprpc.ListGroupsResponse.GroupsEntry.value:type_name -> taprpc.GroupedAssets
	23, // 49: taprpc.ListBalancesResponse.AssetBalancesEntry.value:type_name -> taprpc.AssetBalance
	24, // 50: taprpc.ListBalancesResponse.AssetGroupBalancesEntry.value:type_name -> taprpc.AssetGroupBalance
	5,  // 51: taprpc.TaprootAssets.ListAssets:input_type -> taprpc.ListAssetRequest
	15, // 52: taprpc.TaprootAssets.ListUtxos:input_type -> taprpc.ListUtxosRequest
	18, // 53: taprpc.TaprootAssets.ListGroups:input_type -> taprpc.ListGroupsRequest
	22, // 54: taprpc.TaprootAssets.ListBalances:input_type -> taprpc.ListBalancesRequest
	26, // 55: taprpc.TaprootAssets.ListTransfers:input_type -> taprpc.ListTransfersRequest
	32, // 56: taprpc.TaprootAssets.StopDaemon:input_type -> taprpc.StopRequest
	34, // 57: taprpc.TaprootAssets.DebugLevel:input_type -> taprpc.DebugLevelRequest
	37, // 58: taprpc.TaprootAssets.QueryAddrs:input_type -> taprpc.QueryAddrRequest
	39, // 59: taprpc.TaprootAssets.NewAddr:input_type -> taprpc.NewAddrRequest
	43, // 60: taprpc.TaprootAssets.DecodeAddr:input_type -> taprpc.DecodeAddrRequest
	51, // 61: taprpc.TaprootAssets.AddrReceives:input_type -> taprpc.AddrReceivesRequest
	44, // 62: taprpc.TaprootAssets.VerifyProof:input_type -> taprpc.ProofFile
	47, // 63: taprpc.TaprootAssets.DecodeProof:input_type -> taprpc.DecodeProofRequest
	49, // 64: taprpc.TaprootAssets.ExportProof:input_type -> taprpc.ExportProofRequest
	53, // 65: taprpc.TaprootAssets.SendAsset:input_type -> taprpc.SendAssetRequest
	63, // 66: taprpc.TaprootAssets.BurnAsset:input_type -> taprpc.BurnAssetRequest
	56, // 67: taprpc.TaprootAssets.GetInfo:input_type -> taprpc.GetInfoRequest
	58, // 68: taprpc.TaprootAssets.SubscribeSendAssetEventNtfns:input_type -> taprpc.SubscribeSendAssetEventNtfnsRequest
	62, // 69: taprpc.TaprootAssets.FetchAssetMeta:input_type -> taprpc.FetchAssetMetaRequest
	14, // 70: taprpc.TaprootAssets.ListAssets:output_type -> taprpc.ListAssetResponse
	17, // 71: taprpc.TaprootAssets.ListUtxos:output_type -> taprpc.ListUtxosResponse
	21, // 72: taprpc.TaprootAssets.ListGroups:output_type -> taprpc.ListGroupsResponse
	25, // 73: taprpc.TaprootAssets.ListBalances:output_type -> taprpc.ListBalancesResponse
	27, // 74: taprpc.TaprootAssets.ListTransfers:output_type -> taprpc.ListTransfersResponse
	33, // 75: taprpc.TaprootAssets.StopDaemon:output_type -> taprpc.StopResponse
	35, // 76: taprpc.TaprootAssets.DebugLevel:output_type -> taprpc.DebugLevelResponse
	38, // 77: taprpc.TaprootAssets.QueryAddrs:output_type -> taprpc.QueryAddrResponse
	36, // 78: taprpc.TaprootAssets.NewAddr:output_type -> taprpc.Addr
	36, // 79: taprpc.TaprootAssets.DecodeAddr:output_type -> taprpc.Addr
	52, // 80: taprpc.TaprootAssets.AddrReceives:output_type -> taprpc.AddrReceivesResponse
	46, // 81: taprpc.TaprootAssets.VerifyProof:output_type -> taprpc.VerifyProofResponse
	48, // 82: taprpc.TaprootAssets.DecodeProof:output_type -> taprpc.DecodeProofResponse
	44, // 83: taprpc.TaprootAssets.ExportProof:output_type -> taprpc.ProofFile
	55, // 84: taprpc.TaprootAssets.SendAsset:output_type -> taprpc.SendAssetResponse
	64, // 85: taprpc.TaprootAssets.BurnAsset:output_type -> taprpc.BurnAssetResponse
	57, // 86: taprpc.TaprootAssets.GetInfo:output_type -> taprpc.GetInfoResponse
	59, // 87: taprpc.TaprootAssets.SubscribeSendAssetEventNtfns:output_type -> taprpc.SendAssetEvent
	4,  // 88: taprpc.TaprootAssets.FetchAssetMeta:output_type -> taprpc.AssetMeta

...
var file_taprootassets_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x74, 0x68, 0x22, 0xc1, 0x01, 0x0a,
	...
	0x72, 0x6e, 0x52, 0x05, 0x62, 0x75, 0x72, 0x6e, 0x73, 0x22, 0x41, 0x0a, 0x08, 0x4f, 0x75, 0x74,
	...
	0x4f, 0x52, 0x45, 0x44, 0x10, 0x03, 0x32, 0x9a, 0x0b, 0x0a, 0x0d, 0x54, 0x61, 0x70, 0x72, 0x6f,
	...
	0x74, 0x30, 0x01, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_taprootassets_proto_msgTypes = make([]protoimpl.MessageInfo, 80)
var file_taprootassets_proto_goTypes = []interface{}{
	...
	(*AddrEvent)(nil),                     // 65: taprpc.AddrEvent
	(*AddrReceivesRequest)(nil),           // 66: taprpc.AddrReceivesRequest
	(*AddrReceivesResponse)(nil),          // 67: taprpc.AddrReceivesResponse
	(*SendAssetRequest)(nil),              // 68: taprpc.SendAssetRequest
	(*PrevInputAsset)(nil),                // 69: taprpc.PrevInputAsset
	(*SendAssetResponse)(nil),             // 70: taprpc.SendAssetResponse
	(*GetInfoRequest)(nil),                // 71: taprpc.GetInfoRequest
	(*GetInfoResponse)(nil),               // 72: taprpc.GetInfoResponse
	(*FetchAssetMetaRequest)(nil),         // 73: taprpc.FetchAssetMetaRequest
	(*BurnAssetRequest)(nil),              // 74: taprpc.BurnAssetRequest
	(*BurnAssetResponse)(nil),             // 75: taprpc.BurnAssetResponse
	(*ListBurnsRequest)(nil),              // 76: taprpc.ListBurnsRequest
	(*AssetBurn)(nil),                     // 77: taprpc.AssetBurn
	(*ListBurnsResponse)(nil),             // 78: taprpc.ListBurnsResponse
	(*OutPoint)(nil),                      // 79: taprpc.OutPoint
	(*SubscribeReceiveEventsRequest)(nil), // 80: taprpc.SubscribeReceiveEventsRequest
	(*ReceiveEvent)(nil),                  // 81: taprpc.ReceiveEvent
	(*SubscribeSendEventsRequest)(nil),    // 82: taprpc.SubscribeSendEventsRequest
	(*SendEvent)(nil),                     // 83: taprpc.SendEvent
	(*AnchorTransaction)(nil),             // 84: taprpc.AnchorTransaction
	nil,                                   // 85: taprpc.ListUtxosResponse.ManagedUtxosEntry
	nil,                                   // 86: taprpc.ListGroupsResponse.GroupsEntry
	nil,                                   // 87: taprpc.ListBalancesResponse.AssetBalancesEntry
	nil,                                   // 88: taprpc.ListBalancesResponse.AssetGroupBalancesEntry
}
var file_taprootassets_proto_depIdxs = []int32{
	...
	54, // 2: taprpc.GroupKeyRequest.raw_key:type_name -> taprpc.KeyDescriptor
	12, // 3: taprpc.GroupKeyRequest.anchor_genesis:type_name -> taprpc.GenesisInfo
	15, // 4: taprpc.GroupVirtualTx.prev_out:type_name -> taprpc.TxOut
	...
	18, // 8: taprpc.Asset.asset_group:type_name -> taprpc.AssetGroup
	11, // 9: taprpc.Asset.chain_anchor:type_name -> taprpc.AnchorInfo
	23, // 10: taprpc.Asset.prev_witnesses:type_name -> taprpc.PrevWitness
	21, // 11: taprpc.Asset.decimal_display:type_name -> taprpc.DecimalDisplay
	69, // 12: taprpc.PrevWitness.prev_id:type_name -> taprpc.PrevInputAsset
	24, // 13: taprpc.PrevWitness.split_commitment:type_name -> taprpc.SplitCommitment
	22, // 14: taprpc.SplitCommitment.root_asset:type_name -> taprpc.Asset
	22, // 15: taprpc.ListAssetResponse.assets:type_name -> taprpc.Asset
	22, // 16: taprpc.ManagedUtxo.assets:type_name -> taprpc.Asset
	85, // 17: taprpc.ListUtxosResponse.managed_utxos:type_name -> taprpc.ListUtxosResponse.ManagedUtxosEntry
	...
	30, // 20: taprpc.GroupedAssets.assets:type_name -> taprpc.AssetHumanReadable
	86, // 21: taprpc.ListGroupsResponse.groups:type_name -> taprpc.ListGroupsResponse.GroupsEntry
	12, // 22: taprpc.AssetBalance.asset_genesis:type_name -> taprpc.GenesisInfo
	87, // 23: taprpc.ListBalancesResponse.asset_balances:type_name -> taprpc.ListBalancesResponse.AssetBalancesEntry
	88, // 24: taprpc.ListBalancesResponse.asset_group_balances:type_name -> taprpc.ListBalancesResponse.AssetGroupBalancesEntry
	40, // 25: taprpc.ListTransfersResponse.transfers:type_name -> taprpc.AssetTransfer
	41, // 26: taprpc.AssetTransfer.inputs:type_name -> taprpc.TransferInput
	43, // 27: taprpc.AssetTransfer.outputs:type_name -> taprpc.TransferOutput
	39, // 28: taprpc.AssetTransfer.anchor_tx_block_hash:type_name -> taprpc.ChainHash
	42, // 29: taprpc.TransferOutput.anchor:type_name -> taprpc.TransferOutputAnchor
	...
	48, // 36: taprpc.QueryAddrResponse.addrs:type_name -> taprpc.Addr
	52, // 37: taprpc.NewAddrRequest.script_key:type_name -> taprpc.ScriptKey
	54, // 38: taprpc.NewAddrRequest.internal_key:type_name -> taprpc.KeyDescriptor
	...
	54, // 41: taprpc.ScriptKey.key_desc:type_name -> taprpc.KeyDescriptor
	53, // 42: taprpc.KeyDescriptor.key_loc:type_name -> taprpc.KeyLocator
	56, // 43: taprpc.TapscriptFullTree.all_leaves:type_name -> taprpc.TapLeaf
	22, // 44: taprpc.DecodedProof.asset:type_name -> taprpc.Asset
	9,  // 45: taprpc.DecodedProof.meta_reveal:type_name -> taprpc.AssetMeta
	20, // 46: taprpc.DecodedProof.genesis_reveal:type_name -> taprpc.GenesisReveal
	19, // 47: taprpc.DecodedProof.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	60, // 48: taprpc.VerifyProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	60, // 49: taprpc.DecodeProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	79, // 50: taprpc.ExportProofRequest.outpoint:type_name -> taprpc.OutPoint
	48, // 51: taprpc.AddrEvent.addr:type_name -> taprpc.Addr
	...
	65, // 54: taprpc.AddrReceivesResponse.events:type_name -> taprpc.AddrEvent
	40, // 55: taprpc.SendAssetResponse.transfer:type_name -> taprpc.AssetTransfer
	40, // 56: taprpc.BurnAssetResponse.burn_transfer:type_name -> taprpc.AssetTransfer
	60, // 57: taprpc.BurnAssetResponse.burn_proof:type_name -> taprpc.DecodedProof
	77, // 58: taprpc.ListBurnsResponse.burns:type_name -> taprpc.AssetBurn
	48, // 59: taprpc.ReceiveEvent.address:type_name -> taprpc.Addr
	...
	48, // 62: taprpc.SendEvent.addresses:type_name -> taprpc.Addr
	84, // 63: taprpc.SendEvent.anchor_transaction:type_name -> taprpc.AnchorTransaction
	40, // 64: taprpc.SendEvent.transfer:type_name -> taprpc.AssetTransfer
	79, // 65: taprpc.AnchorTransaction.lnd_locked_utxos:type_name -> taprpc.OutPoint
	27, // 66: taprpc.ListUtxosResponse.ManagedUtxosEntry.value:type_name -> taprpc.ManagedUtxo
	31, // 67: taprpc.ListGroupsResponse.GroupsEntry.value:type_name -> taprpc.GroupedAssets
	34, // 68: taprpc.ListBalancesResponse.AssetBalancesEntry.value:type_name -> taprpc.AssetBalance
	35, // 69: taprpc.ListBalancesResponse.AssetGroupBalancesEntry.value:type_name -> taprpc.AssetGroupBalance
	10, // 70: taprpc.TaprootAssets.ListAssets:input_type -> taprpc.ListAssetRequest
	26, // 71: taprpc.TaprootAssets.ListUtxos:input_type -> taprpc.ListUtxosRequest
	29, // 72: taprpc.TaprootAssets.ListGroups:input_type -> taprpc.ListGroupsRequest
	33, // 73: taprpc.TaprootAssets.ListBalances:input_type -> taprpc.ListBalancesRequest
	37, // 74: taprpc.TaprootAssets.ListTransfers:input_type -> taprpc.ListTransfersRequest
	44, // 75: taprpc.TaprootAssets.StopDaemon:input_type -> taprpc.StopRequest
	46, // 76: taprpc.TaprootAssets.DebugLevel:input_type -> taprpc.DebugLevelRequest
	49, // 77: taprpc.TaprootAssets.QueryAddrs:input_type -> taprpc.QueryAddrRequest
	51, // 78: taprpc.TaprootAssets.NewAddr:input_type -> taprpc.NewAddrRequest
	58, // 79: taprpc.TaprootAssets.DecodeAddr:input_type -> taprpc.DecodeAddrRequest
	66, // 80: taprpc.TaprootAssets.AddrReceives:input_type -> taprpc.AddrReceivesRequest
	59, // 81: taprpc.TaprootAssets.VerifyProof:input_type -> taprpc.ProofFile
	62, // 82: taprpc.TaprootAssets.DecodeProof:input_type -> taprpc.DecodeProofRequest
	64, // 83: taprpc.TaprootAssets.ExportProof:input_type -> taprpc.ExportProofRequest
	68, // 84: taprpc.TaprootAssets.SendAsset:input_type -> taprpc.SendAssetRequest
	74, // 85: taprpc.TaprootAssets.BurnAsset:input_type -> taprpc.BurnAssetRequest
	76, // 86: taprpc.TaprootAssets.ListBurns:input_type -> taprpc.ListBurnsRequest
	71, // 87: taprpc.TaprootAssets.GetInfo:input_type -> taprpc.GetInfoRequest
	73, // 88: taprpc.TaprootAssets.FetchAssetMeta:input_type -> taprpc.FetchAssetMetaRequest
	80, // 89: taprpc.TaprootAssets.SubscribeReceiveEvents:input_type -> taprpc.SubscribeReceiveEventsRequest
	82, // 90: taprpc.TaprootAssets.SubscribeSendEvents:input_type -> taprpc.SubscribeSendEventsRequest
	25, // 91: taprpc.TaprootAssets.ListAssets:output_type -> taprpc.ListAssetResponse
	28, // 92: taprpc.TaprootAssets.ListUtxos:output_type -> taprpc.ListUtxosResponse
	32, // 93: taprpc.TaprootAssets.ListGroups:output_type -> taprpc.ListGroupsResponse
	36, // 94: taprpc.TaprootAssets.ListBalances:output_type -> taprpc.ListBalancesResponse
	38, // 95: taprpc.TaprootAssets.ListTransfers:output_type -> taprpc.ListTransfersResponse
	45, // 96: taprpc.TaprootAssets.StopDaemon:output_type -> taprpc.StopResponse
	47, // 97: taprpc.TaprootAssets.DebugLevel:output_type -> taprpc.DebugLevelResponse
	50, // 98: taprpc.TaprootAssets.QueryAddrs:output_type -> taprpc.QueryAddrResponse
	48, // 99: taprpc.TaprootAssets.NewAddr:output_type -> taprpc.Addr
	48, // 100: taprpc.TaprootAssets.DecodeAddr:output_type -> taprpc.Addr
	67, // 101: taprpc.TaprootAssets.AddrReceives:output_type -> taprpc.AddrReceivesResponse
	61, // 102: taprpc.TaprootAssets.VerifyProof:output_type -> taprpc.VerifyProofResponse
	63, // 103: taprpc.TaprootAssets.DecodeProof:output_type -> taprpc.DecodeProofResponse
	59, // 104: taprpc.TaprootAssets.ExportProof:output_type -> taprpc.ProofFile
	70, // 105: taprpc.TaprootAssets.SendAsset:output_type -> taprpc.SendAssetResponse
	75, // 106: taprpc.TaprootAssets.BurnAsset:output_type -> taprpc.BurnAssetResponse
	78, // 107: taprpc.TaprootAssets.ListBurns:output_type -> taprpc.ListBurnsResponse
	72, // 108: taprpc.TaprootAssets.GetInfo:output_type -> taprpc.GetInfoResponse
	9,  // 109: taprpc.TaprootAssets.FetchAssetMeta:output_type -> taprpc.AssetMeta
	81, // 110: taprpc.TaprootAssets.SubscribeReceiveEvents:output_type -> taprpc.ReceiveEvent
	83, // 111: taprpc.TaprootAssets.SubscribeSendEvents:output_type -> taprpc.SendEvent

...
type AssetGroupBalance struct {
	...
	// The genesis info of a representative issuance in the group. For fungible
	// assets, all tranches share the same name and type, so this provides the
	// canonical metadata for the group.
	AssetGenesis *GenesisInfo `protobuf:"bytes,3,opt,name=asset_genesis,json=assetGenesis,proto3" json:"asset_genesis,omitempty"`
	// The decimal display value for the asset group, extracted from the
	// representative issuance's metadata.
	DecimalDisplay *DecimalDisplay `protobuf:"bytes,4,opt,name=decimal_display,json=decimalDisplay,proto3" json:"decimal_display,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *AssetGroupBalance) GetAssetGenesis() *GenesisInfo {
	if x != nil {
		return x.AssetGenesis
	}
	return nil
...
func (x *AssetGroupBalance) GetDecimalDisplay() *DecimalDisplay {
	if x != nil {
		return x.DecimalDisplay
	}
	return nil
...
var file_taprootassets_proto_depIdxs = []int32{
	...
	16,  // 34: taprpc.AssetGroupBalance.asset_genesis:type_name -> taprpc.GenesisInfo
	25,  // 35: taprpc.AssetGroupBalance.decimal_display:type_name -> taprpc.DecimalDisplay
	103, // 36: taprpc.ListBalancesResponse.asset_balances:type_name -> taprpc.ListBalancesResponse.AssetBalancesEntry
	104, // 37: taprpc.ListBalancesResponse.asset_group_balances:type_name -> taprpc.ListBalancesResponse.AssetGroupBalancesEntry
	44,  // 38: taprpc.ListTransfersResponse.transfers:type_name -> taprpc.AssetTransfer
	45,  // 39: taprpc.AssetTransfer.inputs:type_name -> taprpc.TransferInput
	47,  // 40: taprpc.AssetTransfer.outputs:type_name -> taprpc.TransferOutput
	43,  // 41: taprpc.AssetTransfer.anchor_tx_block_hash:type_name -> taprpc.ChainHash
	0,   // 42: taprpc.TransferInput.asset_type:type_name -> taprpc.AssetType
	46,  // 43: taprpc.TransferOutput.anchor:type_name -> taprpc.TransferOutputAnchor
	3,   // 44: taprpc.TransferOutput.output_type:type_name -> taprpc.OutputType
	2,   // 45: taprpc.TransferOutput.asset_version:type_name -> taprpc.AssetVersion
	4,   // 46: taprpc.TransferOutput.proof_delivery_status:type_name -> taprpc.ProofDeliveryStatus
	0,   // 47: taprpc.TransferOutput.asset_type:type_name -> taprpc.AssetType
	0,   // 48: taprpc.Addr.asset_type:type_name -> taprpc.AssetType
	2,   // 49: taprpc.Addr.asset_version:type_name -> taprpc.AssetVersion
	5,   // 50: taprpc.Addr.address_version:type_name -> taprpc.AddrVersion
	52,  // 51: taprpc.QueryAddrResponse.addrs:type_name -> taprpc.Addr
	57,  // 52: taprpc.NewAddrRequest.script_key:type_name -> taprpc.ScriptKey
	59,  // 53: taprpc.NewAddrRequest.internal_key:type_name -> taprpc.KeyDescriptor
	2,   // 54: taprpc.NewAddrRequest.asset_version:type_name -> taprpc.AssetVersion
	5,   // 55: taprpc.NewAddrRequest.address_version:type_name -> taprpc.AddrVersion
	6,   // 56: taprpc.ScriptKeyTypeQuery.explicit_type:type_name -> taprpc.ScriptKeyType
	59,  // 57: taprpc.ScriptKey.key_desc:type_name -> taprpc.KeyDescriptor
	6,   // 58: taprpc.ScriptKey.type:type_name -> taprpc.ScriptKeyType
	58,  // 59: taprpc.KeyDescriptor.key_loc:type_name -> taprpc.KeyLocator
	61,  // 60: taprpc.TapscriptFullTree.all_leaves:type_name -> taprpc.TapLeaf
	26,  // 61: taprpc.DecodedProof.asset:type_name -> taprpc.Asset
	10,  // 62: taprpc.DecodedProof.meta_reveal:type_name -> taprpc.AssetMeta
	24,  // 63: taprpc.DecodedProof.genesis_reveal:type_name -> taprpc.GenesisReveal
	23,  // 64: taprpc.DecodedProof.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	65,  // 65: taprpc.VerifyProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	65,  // 66: taprpc.DecodeProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	106, // 67: taprpc.ExportProofRequest.outpoint:type_name -> taprpc.OutPoint
	52,  // 68: taprpc.AddrEvent.addr:type_name -> taprpc.Addr
	7,   // 69: taprpc.AddrEvent.status:type_name -> taprpc.AddrEventStatus
	7,   // 70: taprpc.AddrReceivesRequest.filter_status:type_name -> taprpc.AddrEventStatus
	107, // 71: taprpc.AddrReceivesRequest.direction:type_name -> taprpc.SortDirection
	72,  // 72: taprpc.AddrReceivesResponse.events:type_name -> taprpc.AddrEvent
	76,  // 73: taprpc.SendAssetRequest.addresses_with_amounts:type_name -> taprpc.AddressWithAmount
	44,  // 74: taprpc.SendAssetResponse.transfer:type_name -> taprpc.AssetTransfer
	1,   // 75: taprpc.FetchAssetMetaResponse.type:type_name -> taprpc.AssetMetaType
	105, // 76: taprpc.FetchAssetMetaResponse.unknown_odd_types:type_name -> taprpc.FetchAssetMetaResponse.UnknownOddTypesEntry
	11,  // 77: taprpc.BurnAssetRequest.asset_specifier:type_name -> taprpc.AssetSpecifier
	44,  // 78: taprpc.BurnAssetResponse.burn_transfer:type_name -> taprpc.AssetTransfer
	65,  // 79: taprpc.BurnAssetResponse.burn_proof:type_name -> taprpc.DecodedProof
	65,  // 80: taprpc.BurnAssetResponse.burn_proofs:type_name -> taprpc.DecodedProof
	0,   // 81: taprpc.AssetBurn.asset_type:type_name -> taprpc.AssetType
	86,  // 82: taprpc.ListBurnsResponse.burns:type_name -> taprpc.AssetBurn
	52,  // 83: taprpc.ReceiveEvent.address:type_name -> taprpc.Addr
	7,   // 84: taprpc.ReceiveEvent.status:type_name -> taprpc.AddrEventStatus
	9,   // 85: taprpc.SendEvent.parcel_type:type_name -> taprpc.ParcelType
	52,  // 86: taprpc.SendEvent.addresses:type_name -> taprpc.Addr
	92,  // 87: taprpc.SendEvent.anchor_transaction:type_name -> taprpc.AnchorTransaction
	44,  // 88: taprpc.SendEvent.transfer:type_name -> taprpc.AssetTransfer
	106, // 89: taprpc.AnchorTransaction.lnd_locked_utxos:type_name -> taprpc.OutPoint
	106, // 90: taprpc.RegisterTransferRequest.outpoint:type_name -> taprpc.OutPoint
	26,  // 91: taprpc.RegisterTransferResponse.registered_asset:type_name -> taprpc.Asset
	95,  // 92: taprpc.BakeMacaroonRequest.permissions:type_name -> taprpc.MacaroonPermission
	100, // 93: taprpc.ListAnchoringsResponse.anchorings:type_name -> taprpc.Anchoring
	31,  // 94: taprpc.ListUtxosResponse.ManagedUtxosEntry.value:type_name -> taprpc.ManagedUtxo
	35,  // 95: taprpc.ListGroupsResponse.GroupsEntry.value:type_name -> taprpc.GroupedAssets
	38,  // 96: taprpc.ListBalancesResponse.AssetBalancesEntry.value:type_name -> taprpc.AssetBalance
	39,  // 97: taprpc.ListBalancesResponse.AssetGroupBalancesEntry.value:type_name -> taprpc.AssetGroupBalance
	14,  // 98: taprpc.TaprootAssets.ListAssets:input_type -> taprpc.ListAssetRequest
	12,  // 99: taprpc.TaprootAssets.FetchAsset:input_type -> taprpc.FetchAssetRequest
	30,  // 100: taprpc.TaprootAssets.ListUtxos:input_type -> taprpc.ListUtxosRequest
	33,  // 101: taprpc.TaprootAssets.ListGroups:input_type -> taprpc.ListGroupsRequest
	37,  // 102: taprpc.TaprootAssets.ListBalances:input_type -> taprpc.ListBalancesRequest
	41,  // 103: taprpc.TaprootAssets.ListTransfers:input_type -> taprpc.ListTransfersRequest
	98,  // 104: taprpc.TaprootAssets.ListAnchorings:input_type -> taprpc.ListAnchoringsRequest
	48,  // 105: taprpc.TaprootAssets.StopDaemon:input_type -> taprpc.StopRequest
	50,  // 106: taprpc.TaprootAssets.DebugLevel:input_type -> taprpc.DebugLevelRequest
	53,  // 107: taprpc.TaprootAssets.QueryAddrs:input_type -> taprpc.QueryAddrRequest
	55,  // 108: taprpc.TaprootAssets.NewAddr:input_type -> taprpc.NewAddrRequest
	63,  // 109: taprpc.TaprootAssets.DecodeAddr:input_type -> taprpc.DecodeAddrRequest
	73,  // 110: taprpc.TaprootAssets.AddrReceives:input_type -> taprpc.AddrReceivesRequest
	64,  // 111: taprpc.TaprootAssets.VerifyProof:input_type -> taprpc.ProofFile
	67,  // 112: taprpc.TaprootAssets.DecodeProof:input_type -> taprpc.DecodeProofRequest
	69,  // 113: taprpc.TaprootAssets.ExportProof:input_type -> taprpc.ExportProofRequest
	70,  // 114: taprpc.TaprootAssets.UnpackProofFile:input_type -> taprpc.UnpackProofFileRequest
	75,  // 115: taprpc.TaprootAssets.SendAsset:input_type -> taprpc.SendAssetRequest
	83,  // 116: taprpc.TaprootAssets.BurnAsset:input_type -> taprpc.BurnAssetRequest
	85,  // 117: taprpc.TaprootAssets.ListBurns:input_type -> taprpc.ListBurnsRequest
	79,  // 118: taprpc.TaprootAssets.GetInfo:input_type -> taprpc.GetInfoRequest
	96,  // 119: taprpc.TaprootAssets.BakeMacaroon:input_type -> taprpc.BakeMacaroonRequest
	81,  // 120: taprpc.TaprootAssets.FetchAssetMeta:input_type -> taprpc.FetchAssetMetaRequest
	88,  // 121: taprpc.TaprootAssets.SubscribeReceiveEvents:input_type -> taprpc.SubscribeReceiveEventsRequest
	90,  // 122: taprpc.TaprootAssets.SubscribeSendEvents:input_type -> taprpc.SubscribeSendEventsRequest
	93,  // 123: taprpc.TaprootAssets.RegisterTransfer:input_type -> taprpc.RegisterTransferRequest
	29,  // 124: taprpc.TaprootAssets.ListAssets:output_type -> taprpc.ListAssetResponse
	13,  // 125: taprpc.TaprootAssets.FetchAsset:output_type -> taprpc.FetchAssetResponse
	32,  // 126: taprpc.TaprootAssets.ListUtxos:output_type -> taprpc.ListUtxosResponse
	36,  // 127: taprpc.TaprootAssets.ListGroups:output_type -> taprpc.ListGroupsResponse
	40,  // 128: taprpc.TaprootAssets.ListBalances:output_type -> taprpc.ListBalancesResponse
	42,  // 129: taprpc.TaprootAssets.ListTransfers:output_type -> taprpc.ListTransfersResponse
	99,  // 130: taprpc.TaprootAssets.ListAnchorings:output_type -> taprpc.ListAnchoringsResponse
	49,  // 131: taprpc.TaprootAssets.StopDaemon:output_type -> taprpc.StopResponse
	51,  // 132: taprpc.TaprootAssets.DebugLevel:output_type -> taprpc.DebugLevelResponse
	54,  // 133: taprpc.TaprootAssets.QueryAddrs:output_type -> taprpc.QueryAddrResponse
	52,  // 134: taprpc.TaprootAssets.NewAddr:output_type -> taprpc.Addr
	52,  // 135: taprpc.TaprootAssets.DecodeAddr:output_type -> taprpc.Addr
	74,  // 136: taprpc.TaprootAssets.AddrReceives:output_type -> taprpc.AddrReceivesResponse
	66,  // 137: taprpc.TaprootAssets.VerifyProof:output_type -> taprpc.VerifyProofResponse
	68,  // 138: taprpc.TaprootAssets.DecodeProof:output_type -> taprpc.DecodeProofResponse
	64,  // 139: taprpc.TaprootAssets.ExportProof:output_type -> taprpc.ProofFile
	71,  // 140: taprpc.TaprootAssets.UnpackProofFile:output_type -> taprpc.UnpackProofFileResponse
	78,  // 141: taprpc.TaprootAssets.SendAsset:output_type -> taprpc.SendAssetResponse
	84,  // 142: taprpc.TaprootAssets.BurnAsset:output_type -> taprpc.BurnAssetResponse
	87,  // 143: taprpc.TaprootAssets.ListBurns:output_type -> taprpc.ListBurnsResponse
	80,  // 144: taprpc.TaprootAssets.GetInfo:output_type -> taprpc.GetInfoResponse
	97,  // 145: taprpc.TaprootAssets.BakeMacaroon:output_type -> taprpc.BakeMacaroonResponse
	82,  // 146: taprpc.TaprootAssets.FetchAssetMeta:output_type -> taprpc.FetchAssetMetaResponse
	89,  // 147: taprpc.TaprootAssets.SubscribeReceiveEvents:output_type -> taprpc.ReceiveEvent
	91,  // 148: taprpc.TaprootAssets.SubscribeSendEvents:output_type -> taprpc.SendEvent
	94,  // 149: taprpc.TaprootAssets.RegisterTransfer:output_type -> taprpc.RegisterTransferResponse

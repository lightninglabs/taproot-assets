...
var file_taprootassets_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x73, 0x22, 0xae, 0x04, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x9e, 0x01, 0x0a, 0x09, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x4b, 0x65,
...
var file_taprootassets_proto_depIdxs = []int32{
	...
	72, // 13: taprpc.PrevWitness.prev_id:type_name -> taprpc.PrevInputAsset
	25, // 14: taprpc.PrevWitness.split_commitment:type_name -> taprpc.SplitCommitment
	23, // 15: taprpc.SplitCommitment.root_asset:type_name -> taprpc.Asset
	23, // 16: taprpc.ListAssetResponse.assets:type_name -> taprpc.Asset
	23, // 17: taprpc.ManagedUtxo.assets:type_name -> taprpc.Asset
	90, // 18: taprpc.ListUtxosResponse.managed_utxos:type_name -> taprpc.ListUtxosResponse.ManagedUtxosEntry
	...
	31, // 21: taprpc.GroupedAssets.assets:type_name -> taprpc.AssetHumanReadable
	91, // 22: taprpc.ListGroupsResponse.groups:type_name -> taprpc.ListGroupsResponse.GroupsEntry
	13, // 23: taprpc.AssetBalance.asset_genesis:type_name -> taprpc.GenesisInfo
	92, // 24: taprpc.ListBalancesResponse.asset_balances:type_name -> taprpc.ListBalancesResponse.AssetBalancesEntry
	93, // 25: taprpc.ListBalancesResponse.asset_group_balances:type_name -> taprpc.ListBalancesResponse.AssetGroupBalancesEntry
	41, // 26: taprpc.ListTransfersResponse.transfers:type_name -> taprpc.AssetTransfer
	42, // 27: taprpc.AssetTransfer.inputs:type_name -> taprpc.TransferInput
	44, // 28: taprpc.AssetTransfer.outputs:type_name -> taprpc.TransferOutput
	40, // 29: taprpc.AssetTransfer.anchor_tx_block_hash:type_name -> taprpc.ChainHash
	43, // 30: taprpc.TransferOutput.anchor:type_name -> taprpc.TransferOutputAnchor
	...
	49, // 37: taprpc.QueryAddrResponse.addrs:type_name -> taprpc.Addr
	53, // 38: taprpc.NewAddrRequest.script_key:type_name -> taprpc.ScriptKey
	55, // 39: taprpc.NewAddrRequest.internal_key:type_name -> taprpc.KeyDescriptor
	...
	55, // 42: taprpc.ScriptKey.key_desc:type_name -> taprpc.KeyDescriptor
	6,  // 43: taprpc.ScriptKey.type:type_name -> taprpc.ScriptKeyType
	54, // 44: taprpc.KeyDescriptor.key_loc:type_name -> taprpc.KeyLocator
	57, // 45: taprpc.TapscriptFullTree.all_leaves:type_name -> taprpc.TapLeaf
	23, // 46: taprpc.DecodedProof.asset:type_name -> taprpc.Asset
	10, // 47: taprpc.DecodedProof.meta_reveal:type_name -> taprpc.AssetMeta
	21, // 48: taprpc.DecodedProof.genesis_reveal:type_name -> taprpc.GenesisReveal
	20, // 49: taprpc.DecodedProof.group_key_reveal:type_name -> taprpc.GroupKeyReveal
	61, // 50: taprpc.VerifyProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	61, // 51: taprpc.DecodeProofResponse.decoded_proof:type_name -> taprpc.DecodedProof
	82, // 52: taprpc.ExportProofRequest.outpoint:type_name -> taprpc.OutPoint
	49, // 53: taprpc.AddrEvent.addr:type_name -> taprpc.Addr
	7,  // 54: taprpc.AddrEvent.status:type_name -> taprpc.AddrEventStatus
	7,  // 55: taprpc.AddrReceivesRequest.filter_status:type_name -> taprpc.AddrEventStatus
	68, // 56: taprpc.AddrReceivesResponse.events:type_name -> taprpc.AddrEvent
	41, // 57: taprpc.SendAssetResponse.transfer:type_name -> taprpc.AssetTransfer
	41, // 58: taprpc.BurnAssetResponse.burn_transfer:type_name -> taprpc.AssetTransfer
	61, // 59: taprpc.BurnAssetResponse.burn_proof:type_name -> taprpc.DecodedProof
	80, // 60: taprpc.ListBurnsResponse.burns:type_name -> taprpc.AssetBurn
	49, // 61: taprpc.ReceiveEvent.address:type_name -> taprpc.Addr
	7,  // 62: taprpc.ReceiveEvent.status:type_name -> taprpc.AddrEventStatus
	9,  // 63: taprpc.SendEvent.parcel_type:type_name -> taprpc.ParcelType
	49, // 64: taprpc.SendEvent.addresses:type_name -> taprpc.Addr
	87, // 65: taprpc.SendEvent.anchor_transaction:type_name -> taprpc.AnchorTransaction
	41, // 66: taprpc.SendEvent.transfer:type_name -> taprpc.AssetTransfer
	82, // 67: taprpc.AnchorTransaction.lnd_locked_utxos:type_name -> taprpc.OutPoint
	82, // 68: taprpc.RegisterTransferRequest.outpoint:type_name -> taprpc.OutPoint
	23, // 69: taprpc.RegisterTransferResponse.registered_asset:type_name -> taprpc.Asset
	28, // 70: taprpc.ListUtxosResponse.ManagedUtxosEntry.value:type_name -> taprpc.ManagedUtxo
	32, // 71: taprpc.ListGroupsResponse.GroupsEntry.value:type_name -> taprpc.GroupedAssets
	35, // 72: taprpc.ListBalancesResponse.AssetBalancesEntry.value:type_name -> taprpc.AssetBalance
	36, // 73: taprpc.ListBalancesResponse.AssetGroupBalancesEntry.value:type_name -> taprpc.AssetGroupBalance
	11, // 74: taprpc.TaprootAssets.ListAssets:input_type -> taprpc.ListAssetRequest
	27, // 75: taprpc.TaprootAssets.ListUtxos:input_type -> taprpc.ListUtxosRequest
	30, // 76: taprpc.TaprootAssets.ListGroups:input_type -> taprpc.ListGroupsRequest
	34, // 77: taprpc.TaprootAssets.ListBalances:input_type -> taprpc.ListBalancesRequest
	38, // 78: taprpc.TaprootAssets.ListTransfers:input_type -> taprpc.ListTransfersRequest
	45, // 79: taprpc.TaprootAssets.StopDaemon:input_type -> taprpc.StopRequest
	47, // 80: taprpc.TaprootAssets.DebugLevel:input_type -> taprpc.DebugLevelRequest
	50, // 81: taprpc.TaprootAssets.QueryAddrs:input_type -> taprpc.QueryAddrRequest
	52, // 82: taprpc.TaprootAssets.NewAddr:input_type -> taprpc.NewAddrRequest
	59, // 83: taprpc.TaprootAssets.DecodeAddr:input_type -> taprpc.DecodeAddrRequest
	69, // 84: taprpc.TaprootAssets.AddrReceives:input_type -> taprpc.AddrReceivesRequest
	60, // 85: taprpc.TaprootAssets.VerifyProof:input_type -> taprpc.ProofFile
	63, // 86: taprpc.TaprootAssets.DecodeProof:input_type -> taprpc.DecodeProofRequest
	65, // 87: taprpc.TaprootAssets.ExportProof:input_type -> taprpc.ExportProofRequest
	66, // 88: taprpc.TaprootAssets.UnpackProofFile:input_type -> taprpc.UnpackProofFileRequest
	71, // 89: taprpc.TaprootAssets.SendAsset:input_type -> taprpc.SendAssetRequest
	77, // 90: taprpc.TaprootAssets.BurnAsset:input_type -> taprpc.BurnAssetRequest
	79, // 91: taprpc.TaprootAssets.ListBurns:input_type -> taprpc.ListBurnsRequest
	74, // 92: taprpc.TaprootAssets.GetInfo:input_type -> taprpc.GetInfoRequest
	76, // 93: taprpc.TaprootAssets.FetchAssetMeta:input_type -> taprpc.FetchAssetMetaRequest
	83, // 94: taprpc.TaprootAssets.SubscribeReceiveEvents:input_type -> taprpc.SubscribeReceiveEventsRequest
	85, // 95: taprpc.TaprootAssets.SubscribeSendEvents:input_type -> taprpc.SubscribeSendEventsRequest
	88, // 96: taprpc.TaprootAssets.RegisterTransfer:input_type -> taprpc.RegisterTransferRequest
	26, // 97: taprpc.TaprootAssets.ListAssets:output_type -> taprpc.ListAssetResponse
	29, // 98: taprpc.TaprootAssets.ListUtxos:output_type -> taprpc.ListUtxosResponse
	33, // 99: taprpc.TaprootAssets.ListGroups:output_type -> taprpc.ListGroupsResponse
	37, // 100: taprpc.TaprootAssets.ListBalances:output_type -> taprpc.ListBalancesResponse
	39, // 101: taprpc.TaprootAssets.ListTransfers:output_type -> taprpc.ListTransfersResponse
	46, // 102: taprpc.TaprootAssets.StopDaemon:output_type -> taprpc.StopResponse
	48, // 103: taprpc.TaprootAssets.DebugLevel:output_type -> taprpc.DebugLevelResponse
	51, // 104: taprpc.TaprootAssets.QueryAddrs:output_type -> taprpc.QueryAddrResponse
	49, // 105: taprpc.TaprootAssets.NewAddr:output_type -> taprpc.Addr
	49, // 106: taprpc.TaprootAssets.DecodeAddr:output_type -> taprpc.Addr
	70, // 107: taprpc.TaprootAssets.AddrReceives:output_type -> taprpc.AddrReceivesResponse
	62, // 108: taprpc.TaprootAssets.VerifyProof:output_type -> taprpc.VerifyProofResponse
	64, // 109: taprpc.TaprootAssets.DecodeProof:output_type -> taprpc.DecodeProofResponse
	60, // 110: taprpc.TaprootAssets.ExportProof:output_type -> taprpc.ProofFile
	67, // 111: taprpc.TaprootAssets.UnpackProofFile:output_type -> taprpc.UnpackProofFileResponse
	73, // 112: taprpc.TaprootAssets.SendAsset:output_type -> taprpc.SendAssetResponse
	78, // 113: taprpc.TaprootAssets.BurnAsset:output_type -> taprpc.BurnAssetResponse
	81, // 114: taprpc.TaprootAssets.ListBurns:output_type -> taprpc.ListBurnsResponse
	75, // 115: taprpc.TaprootAssets.GetInfo:output_type -> taprpc.GetInfoResponse
	10, // 116: taprpc.TaprootAssets.FetchAssetMeta:output_type -> taprpc.AssetMeta
	84, // 117: taprpc.TaprootAssets.SubscribeReceiveEvents:output_type -> taprpc.ReceiveEvent
	86, // 118: taprpc.TaprootAssets.SubscribeSendEvents:output_type -> taprpc.SendEvent
	89, // 119: taprpc.TaprootAssets.RegisterTransfer:output_type -> taprpc.RegisterTransferResponse

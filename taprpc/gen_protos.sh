...
function generate() {
  ...
  PROTOS="taprootassets.proto assetwalletrpc/assetwallet.proto mintrpc/mint.proto rfqrpc/rfq.proto universerpc/universe.proto tapdevrpc/tapdev.proto testrpc/test.proto"
  ...
  PACKAGES="assetwalletrpc universerpc mintrpc rfqrpc testrpc"

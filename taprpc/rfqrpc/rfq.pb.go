...
type QueryForwardingHistoryRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// start_time is the starting time of the query as a unix timestamp in
	// seconds. If not specified, the query will start from the beginning.
	StartTime uint64 `protobuf:"varint,1,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// end_time is the ending time of the query as a unix timestamp in seconds.
	// If not specified, the query will end at the current time.
	EndTime uint64 `protobuf:"varint,2,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	// asset_id_filter filters the forwarding history by asset ID. If not
	// specified, all assets are included.
	AssetIdFilter []byte `protobuf:"bytes,3,opt,name=asset_id_filter,json=assetIdFilter,proto3" json:"asset_id_filter,omitempty"`
	// The offset for the page.
	Offset int32 `protobuf:"varint,4,opt,name=offset,proto3" json:"offset,omitempty"`
	// The length limit for the page.
	Limit int32 `protobuf:"varint,5,opt,name=limit,proto3" json:"limit,omitempty"`
	// The direction of the page.
	Direction taprpc.SortDirection `protobuf:"varint,6,opt,name=direction,proto3,enum=taprpc.SortDirection" json:"direction,omitempty"`
}

func (x *QueryForwardingHistoryRequest) Reset() {
	*x = QueryForwardingHistoryRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryForwardingHistoryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryForwardingHistoryRequest) ProtoMessage() {}

func (x *QueryForwardingHistoryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rfqrpc_rfq_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryForwardingHistoryRequest.ProtoReflect.Descriptor instead.
func (*QueryForwardingHistoryRequest) Descriptor() ([]byte, []int) {
	return file_rfqrpc_rfq_proto_rawDescGZIP(), []int{22}
}

func (x *QueryForwardingHistoryRequest) GetStartTime() uint64 {
	if x != nil {
		return x.StartTime
	}
	return 0
...
func (x *QueryForwardingHistoryRequest) GetEndTime() uint64 {
	if x != nil {
		return x.EndTime
	}
	return 0
...
func (x *QueryForwardingHistoryRequest) GetAssetIdFilter() []byte {
	if x != nil {
...
func (x *QueryForwardingHistoryRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *QueryForwardingHistoryRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *QueryForwardingHistoryRequest) GetDirection() taprpc.SortDirection {
	if x != nil {
		return x.Direction
	}
...
type ForwardingHistoryEvent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// timestamp is the time when the forwarding event occurred as a unix
	// timestamp in seconds.
	Timestamp uint64 `protobuf:"varint,1,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	// incoming_htlc_id is the ID of the incoming HTLC.
	IncomingHtlcId uint64 `protobuf:"varint,2,opt,name=incoming_htlc_id,json=incomingHtlcId,proto3" json:"incoming_htlc_id,omitempty"`
	// outgoing_htlc_id is the ID of the outgoing HTLC.
	OutgoingHtlcId uint64 `protobuf:"varint,3,opt,name=outgoing_htlc_id,json=outgoingHtlcId,proto3" json:"outgoing_htlc_id,omitempty"`
	// asset_id is the 32-byte asset ID of the forwarded asset.
	AssetId []byte `protobuf:"bytes,4,opt,name=asset_id,json=assetId,proto3" json:"asset_id,omitempty"`
	// amount_in_msat is the incoming amount in millisatoshis.
	AmountInMsat uint64 `protobuf:"varint,5,opt,name=amount_in_msat,json=amountInMsat,proto3" json:"amount_in_msat,omitempty"`
	// amount_out_msat is the outgoing amount in millisatoshis.
	AmountOutMsat uint64 `protobuf:"varint,6,opt,name=amount_out_msat,json=amountOutMsat,proto3" json:"amount_out_msat,omitempty"`
	// rate is the exchange rate used for this forward.
	Rate *FixedPoint `protobuf:"bytes,7,opt,name=rate,proto3" json:"rate,omitempty"`
	// fee_msat is the fee earned in millisatoshis.
	FeeMsat uint64 `protobuf:"varint,8,opt,name=fee_msat,json=feeMsat,proto3" json:"fee_msat,omitempty"`
	// incoming_channel_id is the incoming channel ID.
	IncomingChannelId uint64 `protobuf:"varint,9,opt,name=incoming_channel_id,json=incomingChannelId,proto3" json:"incoming_channel_id,omitempty"`
	// outgoing_channel_id is the outgoing channel ID.
	OutgoingChannelId uint64 `protobuf:"varint,10,opt,name=outgoing_channel_id,json=outgoingChannelId,proto3" json:"outgoing_channel_id,omitempty"`
}

func (x *ForwardingHistoryEvent) Reset() {
	*x = ForwardingHistoryEvent{}
	if protoimpl.UnsafeEnabled {
...
func (x *ForwardingHistoryEvent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForwardingHistoryEvent) ProtoMessage() {}

func (x *ForwardingHistoryEvent) ProtoReflect() protoreflect.Message {
	mi := &file_rfqrpc_rfq_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ForwardingHistoryEvent.ProtoReflect.Descriptor instead.
func (*ForwardingHistoryEvent) Descriptor() ([]byte, []int) {
	return file_rfqrpc_rfq_proto_rawDescGZIP(), []int{23}
}

func (x *ForwardingHistoryEvent) GetTimestamp() uint64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *ForwardingHistoryEvent) GetIncomingHtlcId() uint64 {
	if x != nil {
...
func (x *ForwardingHistoryEvent) GetOutgoingHtlcId() uint64 {
	if x != nil {
...
func (x *ForwardingHistoryEvent) GetAssetId() []byte {
	if x != nil {
		return x.AssetId
	}
	return nil
...
func (x *ForwardingHistoryEvent) GetAmountInMsat() uint64 {
	if x != nil {
		return x.AmountInMsat
	}
	return 0
}

func (x *ForwardingHistoryEvent) GetAmountOutMsat() uint64 {
	if x != nil {
		return x.AmountOutMsat
	}
	return 0
}

func (x *ForwardingHistoryEvent) GetRate() *FixedPoint {
	if x != nil {
		return x.Rate
	}
	return nil
...
func (x *ForwardingHistoryEvent) GetFeeMsat() uint64 {
	if x != nil {
		return x.FeeMsat
	}
	return 0
...
func (x *ForwardingHistoryEvent) GetIncomingChannelId() uint64 {
	if x != nil {
...
func (x *ForwardingHistoryEvent) GetOutgoingChannelId() uint64 {
	if x != nil {
...
type QueryForwardingHistoryResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// events is the list of forwarding events.
	Events []*ForwardingHistoryEvent `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty"`
}

func (x *QueryForwardingHistoryResponse) Reset() {
	*x = QueryForwardingHistoryResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryForwardingHistoryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryForwardingHistoryResponse) ProtoMessage() {}

func (x *QueryForwardingHistoryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rfqrpc_rfq_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryForwardingHistoryResponse.ProtoReflect.Descriptor instead.
func (*QueryForwardingHistoryResponse) Descriptor() ([]byte, []int) {
	return file_rfqrpc_rfq_proto_rawDescGZIP(), []int{24}
}

func (x *QueryForwardingHistoryResponse) GetEvents() []*ForwardingHistoryEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
var file_rfqrpc_rfq_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x06, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x1a, 0x0f, 0x74, 0x61, 0x70, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9c, 0x01, 0x0a, 0x0e,
	0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1b,
	...
	,
	...
	0x73, 0x73, 0x65, 0x74, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x22, 0x0a,
	0x0d, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x61, 0x6d, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x61, 0x73, 0x73, 0x65, 0x74, 0x4d, 0x61, 0x78, 0x41, 0x6d,
	0x74, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x12, 0x20, 0x0a, 0x0c, 0x70, 0x65, 0x65,
	0x72, 0x5f, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0a, 0x70, 0x65, 0x65, 0x72, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x27, 0x0a, 0x0f, 0x74,
	...
	,
	...
	0x73, 0x65, 0x74, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x26, 0x0a, 0x0f,
	0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x61, 0x6d, 0x74, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x61,
	0x78, 0x41, 0x6d, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x12, 0x20, 0x0a, 0x0c,
	0x70, 0x65, 0x65, 0x72, 0x5f, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x0a, 0x70, 0x65, 0x65, 0x72, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x27,
	...
	0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x37, 0x0a, 0x18, 0x73, 0x6b, 0x69, 0x70, 0x5f,
	0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x5f, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x15, 0x73, 0x6b, 0x69, 0x70, 0x41,
	0x73, 0x73, 0x65, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x64, 0x61, 0x74, 0x61, 0x22, 0xfc, 0x01, 0x0a, 0x19, 0x41, 0x64, 0x64, 0x41, 0x73, 0x73, 0x65,
	0x74, 0x53, 0x65, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x46, 0x0a, 0x0e, 0x61, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x5f, 0x71,
	0x75, 0x6f, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x66, 0x71,
	0x72, 0x70, 0x63, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64,
	0x53, 0x65, 0x6c, 0x6c, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x48, 0x00, 0x52, 0x0d, 0x61, 0x63, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x72, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x73, 0x61, 0x74, 0x12, 0x32, 0x0a, 0x15, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x5f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x70, 0x72, 0x69, 0x63, 0x65,
	0x4f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x30,
	0x0a, 0x0a, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x73, 0x73, 0x65,
	0x74, 0x53, 0x70, 0x65, 0x63, 0x52, 0x09, 0x61, 0x73, 0x73, 0x65, 0x74, 0x53, 0x70, 0x65, 0x63,
	...
	0x07, 0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xe4, 0x01, 0x0a, 0x1d, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x48, 0x69, 0x73, 0x74,
	...
	0x54, 0x69, 0x6d, 0x65, 0x12, 0x26, 0x0a, 0x0f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64,
	0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x61,
	0x73, 0x73, 0x65, 0x74, 0x49, 0x64, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06,
	...
	0x96, 0x03, 0x0a, 0x16, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x48, 0x69,
	0x73, 0x74, 0x6f, 0x72, 0x79, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x74,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x28, 0x0a, 0x10, 0x69, 0x6e, 0x63, 0x6f,
	0x6d, 0x69, 0x6e, 0x67, 0x5f, 0x68, 0x74, 0x6c, 0x63, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01,
	...
	,
	...
	0x0a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x6f, 0x75, 0x74, 0x67, 0x6f, 0x69, 0x6e, 0x67, 0x43,
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x22, 0x58, 0x0a, 0x1e, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x48, 0x69, 0x73, 0x74, 0x6f,
	0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x72, 0x66, 0x71,
	...
	0x74, 0x73, 0x2a, 0x5a, 0x0a, 0x0f, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x53,
	...
	0x4c, 0x45, 0x5f, 0x51, 0x55, 0x45, 0x52, 0x59, 0x5f, 0x45, 0x52, 0x52, 0x10, 0x02, 0x32, 0x91,
	0x05, 0x0a, 0x03, 0x52, 0x66, 0x71, 0x12, 0x55, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x41, 0x73, 0x73,
	...
	0x66, 0x71, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x12, 0x67, 0x0a, 0x16, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x48, 0x69, 0x73, 0x74,
	0x6f, 0x72, 0x79, 0x12, 0x25, 0x2e, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x2e, 0x51, 0x75, 0x65,
	0x72, 0x79, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x48, 0x69, 0x73, 0x74,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x72, 0x66, 0x71,
	0x72, 0x70, 0x63, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64,
	...
	0x70, 0x72, 0x70, 0x63, 0x2f, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_rfqrpc_rfq_proto_goTypes = []any{
	...
	(*AssetSpec)(nil),                       // 12: rfqrpc.AssetSpec
	(*PeerAcceptedBuyQuote)(nil),            // 13: rfqrpc.PeerAcceptedBuyQuote
	(*PeerAcceptedSellQuote)(nil),           // 14: rfqrpc.PeerAcceptedSellQuote
	(*InvalidQuoteResponse)(nil),            // 15: rfqrpc.InvalidQuoteResponse
	(*RejectedQuoteResponse)(nil),           // 16: rfqrpc.RejectedQuoteResponse
	(*QueryPeerAcceptedQuotesResponse)(nil), // 17: rfqrpc.QueryPeerAcceptedQuotesResponse
	(*SubscribeRfqEventNtfnsRequest)(nil),   // 18: rfqrpc.SubscribeRfqEventNtfnsRequest
	(*PeerAcceptedBuyQuoteEvent)(nil),       // 19: rfqrpc.PeerAcceptedBuyQuoteEvent
	(*PeerAcceptedSellQuoteEvent)(nil),      // 20: rfqrpc.PeerAcceptedSellQuoteEvent
	(*AcceptHtlcEvent)(nil),                 // 21: rfqrpc.AcceptHtlcEvent
	(*RfqEvent)(nil),                        // 22: rfqrpc.RfqEvent
	(*QueryForwardingHistoryRequest)(nil),   // 23: rfqrpc.QueryForwardingHistoryRequest
	(*ForwardingHistoryEvent)(nil),          // 24: rfqrpc.ForwardingHistoryEvent
	(*QueryForwardingHistoryResponse)(nil),  // 25: rfqrpc.QueryForwardingHistoryResponse
	(taprpc.SortDirection)(0),               // 26: taprpc.SortDirection
}
var file_rfqrpc_rfq_proto_depIdxs = []int32{
	...
	13, // 1: rfqrpc.AddAssetBuyOrderResponse.accepted_quote:type_name -> rfqrpc.PeerAcceptedBuyQuote
	15, // 2: rfqrpc.AddAssetBuyOrderResponse.invalid_quote:type_name -> rfqrpc.InvalidQuoteResponse
	16, // 3: rfqrpc.AddAssetBuyOrderResponse.rejected_quote:type_name -> rfqrpc.RejectedQuoteResponse
	1,  // 4: rfqrpc.AddAssetSellOrderRequest.asset_specifier:type_name -> rfqrpc.AssetSpecifier
	14, // 5: rfqrpc.AddAssetSellOrderResponse.accepted_quote:type_name -> rfqrpc.PeerAcceptedSellQuote
	15, // 6: rfqrpc.AddAssetSellOrderResponse.invalid_quote:type_name -> rfqrpc.InvalidQuoteResponse
	16, // 7: rfqrpc.AddAssetSellOrderResponse.rejected_quote:type_name -> rfqrpc.RejectedQuoteResponse
	...
	12, // 11: rfqrpc.PeerAcceptedBuyQuote.asset_spec:type_name -> rfqrpc.AssetSpec
	2,  // 12: rfqrpc.PeerAcceptedSellQuote.bid_asset_rate:type_name -> rfqrpc.FixedPoint
	12, // 13: rfqrpc.PeerAcceptedSellQuote.asset_spec:type_name -> rfqrpc.AssetSpec
	0,  // 14: rfqrpc.InvalidQuoteResponse.status:type_name -> rfqrpc.QuoteRespStatus
	13, // 15: rfqrpc.QueryPeerAcceptedQuotesResponse.buy_quotes:type_name -> rfqrpc.PeerAcceptedBuyQuote
	14, // 16: rfqrpc.QueryPeerAcceptedQuotesResponse.sell_quotes:type_name -> rfqrpc.PeerAcceptedSellQuote
	13, // 17: rfqrpc.PeerAcceptedBuyQuoteEvent.peer_accepted_buy_quote:type_name -> rfqrpc.PeerAcceptedBuyQuote
	14, // 18: rfqrpc.PeerAcceptedSellQuoteEvent.peer_accepted_sell_quote:type_name -> rfqrpc.PeerAcceptedSellQuote
	19, // 19: rfqrpc.RfqEvent.peer_accepted_buy_quote:type_name -> rfqrpc.PeerAcceptedBuyQuoteEvent
	20, // 20: rfqrpc.RfqEvent.peer_accepted_sell_quote:type_name -> rfqrpc.PeerAcceptedSellQuoteEvent
	21, // 21: rfqrpc.RfqEvent.accept_htlc:type_name -> rfqrpc.AcceptHtlcEvent
	26, // 22: rfqrpc.QueryForwardingHistoryRequest.direction:type_name -> taprpc.SortDirection
	2,  // 23: rfqrpc.ForwardingHistoryEvent.rate:type_name -> rfqrpc.FixedPoint
	24, // 24: rfqrpc.QueryForwardingHistoryResponse.events:type_name -> rfqrpc.ForwardingHistoryEvent
	3,  // 25: rfqrpc.Rfq.AddAssetBuyOrder:input_type -> rfqrpc.AddAssetBuyOrderRequest
	5,  // 26: rfqrpc.Rfq.AddAssetSellOrder:input_type -> rfqrpc.AddAssetSellOrderRequest
	7,  // 27: rfqrpc.Rfq.AddAssetSellOffer:input_type -> rfqrpc.AddAssetSellOfferRequest
	9,  // 28: rfqrpc.Rfq.AddAssetBuyOffer:input_type -> rfqrpc.AddAssetBuyOfferRequest
	11, // 29: rfqrpc.Rfq.QueryPeerAcceptedQuotes:input_type -> rfqrpc.QueryPeerAcceptedQuotesRequest
	18, // 30: rfqrpc.Rfq.SubscribeRfqEventNtfns:input_type -> rfqrpc.SubscribeRfqEventNtfnsRequest
	23, // 31: rfqrpc.Rfq.QueryForwardingHistory:input_type -> rfqrpc.QueryForwardingHistoryRequest
	4,  // 32: rfqrpc.Rfq.AddAssetBuyOrder:output_type -> rfqrpc.AddAssetBuyOrderResponse
	6,  // 33: rfqrpc.Rfq.AddAssetSellOrder:output_type -> rfqrpc.AddAssetSellOrderResponse
	8,  // 34: rfqrpc.Rfq.AddAssetSellOffer:output_type -> rfqrpc.AddAssetSellOfferResponse
	10, // 35: rfqrpc.Rfq.AddAssetBuyOffer:output_type -> rfqrpc.AddAssetBuyOfferResponse
	17, // 36: rfqrpc.Rfq.QueryPeerAcceptedQuotes:output_type -> rfqrpc.QueryPeerAcceptedQuotesResponse
	22, // 37: rfqrpc.Rfq.SubscribeRfqEventNtfns:output_type -> rfqrpc.RfqEvent
	25, // 38: rfqrpc.Rfq.QueryForwardingHistory:output_type -> rfqrpc.QueryForwardingHistoryResponse
...
func file_rfqrpc_rfq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rfqrpc_rfq_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*QueryForwardingHistoryRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rfqrpc_rfq_proto_msgTypes[23].Exporter = func(v any, i int) any {
			switch v := v.(*ForwardingHistoryEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rfqrpc_rfq_proto_msgTypes[24].Exporter = func(v any, i int) any {
			switch v := v.(*QueryForwardingHistoryResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

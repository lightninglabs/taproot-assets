...
type QueryRfqForwardsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// min_timestamp is the minimum Unix timestamp in seconds. Only forwards
	// that settled at or after this time are returned. If not set, there is
	// no lower bound.
	MinTimestamp uint64 `protobuf:"varint,1,opt,name=min_timestamp,json=minTimestamp,proto3" json:"min_timestamp,omitempty"`
	// max_timestamp is the maximum Unix timestamp in seconds. Only forwards
	// that settled at or before this time are returned. If not set, there is
	// no upper bound.
	...
	// only forwards involving this peer are returned.
	Peer []byte `protobuf:"bytes,3,opt,name=peer,proto3" json:"peer,omitempty"`
	// asset_specifier optionally filters forwards by asset ID or group key.
...
func (x *QueryRfqForwardsRequest) Reset() {
	*x = QueryRfqForwardsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryRfqForwardsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryRfqForwardsRequest) ProtoMessage() {}

func (x *QueryRfqForwardsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_rfqrpc_rfq_proto_msgTypes[22]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryRfqForwardsRequest.ProtoReflect.Descriptor instead.
func (*QueryRfqForwardsRequest) Descriptor() ([]byte, []int) {
	return file_rfqrpc_rfq_proto_rawDescGZIP(), []int{22}
}

func (x *QueryRfqForwardsRequest) GetMinTimestamp() uint64 {
	if x != nil {
...
func (x *QueryRfqForwardsRequest) GetMaxTimestamp() uint64 {
	if x != nil {
...
func (x *QueryRfqForwardsRequest) GetPeer() []byte {
	if x != nil {
		return x.Peer
	}
	return nil
...
func (x *QueryRfqForwardsRequest) GetAssetSpecifier() *AssetSpecifier {
	if x != nil {
		return x.AssetSpecifier
	}
	return nil
...
func (x *QueryRfqForwardsRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *QueryRfqForwardsRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
type QueryRfqForwardsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// forwards is the list of completed asset forwards matching the query.
	Forwards []*RfqForward `protobuf:"bytes,1,rep,name=forwards,proto3" json:"forwards,omitempty"`
	...
	// total_asset_volume is the sum of asset amounts for all forwards
	// matching the filter (before pagination is applied). This represents
	// the total swap volume in asset units.
	TotalAssetVolume uint64 `protobuf:"varint,3,opt,name=total_asset_volume,json=totalAssetVolume,proto3" json:"total_asset_volume,omitempty"`
}

func (x *QueryRfqForwardsResponse) Reset() {
	*x = QueryRfqForwardsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryRfqForwardsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryRfqForwardsResponse) ProtoMessage() {}

func (x *QueryRfqForwardsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_rfqrpc_rfq_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryRfqForwardsResponse.ProtoReflect.Descriptor instead.
func (*QueryRfqForwardsResponse) Descriptor() ([]byte, []int) {
	return file_rfqrpc_rfq_proto_rawDescGZIP(), []int{23}
}

func (x *QueryRfqForwardsResponse) GetForwards() []*RfqForward {
	if x != nil {
		return x.Forwards
	}
	return nil
...
func (x *QueryRfqForwardsResponse) GetTotalCount() int64 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
func (x *QueryRfqForwardsResponse) GetTotalAssetVolume() uint64 {
	if x != nil {
		return x.TotalAssetVolume
	}
	return 0
}
...
type RfqForward struct {
	...
	// id is the database ID of this forward record.
	Id int64 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	// settled_at is the Unix timestamp in seconds when the forward settled.
	SettledAt uint64 `protobuf:"varint,2,opt,name=settled_at,json=settledAt,proto3" json:"settled_at,omitempty"`
	// rfq_id is the unique identifier of the RFQ session that governed this
	// forward.
	RfqId []byte `protobuf:"bytes,3,opt,name=rfq_id,json=rfqId,proto3" json:"rfq_id,omitempty"`
	// chan_id_in is the short channel ID of the incoming channel.
	ChanIdIn uint64 `protobuf:"varint,4,opt,name=chan_id_in,json=chanIdIn,proto3" json:"chan_id_in,omitempty"`
	// chan_id_out is the short channel ID of the outgoing channel.
	ChanIdOut uint64 `protobuf:"varint,5,opt,name=chan_id_out,json=chanIdOut,proto3" json:"chan_id_out,omitempty"`
	// htlc_id is the HTLC ID on the incoming channel.
	HtlcId uint64 `protobuf:"varint,6,opt,name=htlc_id,json=htlcId,proto3" json:"htlc_id,omitempty"`
	// asset_amt is the asset amount that was swapped.
	AssetAmt uint64 `protobuf:"varint,9,opt,name=asset_amt,json=assetAmt,proto3" json:"asset_amt,omitempty"`
...
func (x *RfqForward) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RfqForward) ProtoMessage() {}

func (x *RfqForward) ProtoReflect() protoreflect.Message {
	mi := &file_rfqrpc_rfq_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RfqForward.ProtoReflect.Descriptor instead.
func (*RfqForward) Descriptor() ([]byte, []int) {
	return file_rfqrpc_rfq_proto_rawDescGZIP(), []int{24}
}

func (x *RfqForward) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *RfqForward) GetSettledAt() uint64 {
	if x != nil {
		return x.SettledAt
	}
	return 0
...
func (x *RfqForward) GetRfqId() []byte {
	if x != nil {
		return x.RfqId
	}
	return nil
...
func (x *RfqForward) GetChanIdIn() uint64 {
	if x != nil {
		return x.ChanIdIn
	}
	return 0
...
func (x *RfqForward) GetChanIdOut() uint64 {
	if x != nil {
		return x.ChanIdOut
	}
	return 0
...
func (x *RfqForward) GetHtlcId() uint64 {
	if x != nil {
		return x.HtlcId
	}
	return 0
...
func (x *RfqForward) GetAssetAmt() uint64 {
	if x != nil {
		return x.AssetAmt
	}
	return 0
...
func (x *RfqForward) GetPolicyType() RfqPolicyType {
	if x != nil {
		return x.PolicyType
	}
...
func (x *RfqForward) GetPeer() string {
	if x != nil {
		return x.Peer
	}
	return ""
...
func (x *RfqForward) GetAssetSpec() *AssetSpec {
	if x != nil {
		return x.AssetSpec
	}
	return nil
...
func (x *RfqForward) GetRate() *FixedPoint {
	if x != nil {
		return x.Rate
	}
	return nil
...
var file_rfqrpc_rfq_proto_rawDesc = []byte{
	...
	0xce, 0x02, 0x0a, 0x17, 0x41, 0x64, 0x64, 0x41, 0x73, 0x73, 0x65, 0x74, 0x42, 0x75, 0x79, 0x4f,
	...
	,
	...
	0x65, 0x74, 0x53, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x26, 0x0a, 0x0f, 0x70,
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6d, 0x61, 0x78, 0x5f, 0x61, 0x6d, 0x74, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x0d, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x61, 0x78,
	0x41, 0x6d, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x06, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x12, 0x20, 0x0a, 0x0c, 0x70,
	0x65, 0x65, 0x72, 0x5f, 0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x0a, 0x70, 0x65, 0x65, 0x72, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x27, 0x0a,
	...
	,
	...
	0x0a, 0x05, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x22, 0xe6, 0x01, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x52, 0x66, 0x71, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x6d, 0x69, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73,
	0x74, 0x61, 0x6d, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0c, 0x6d, 0x69, 0x6e, 0x54,
	...
	0x0c, 0x6d, 0x61, 0x78, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x12, 0x0a,
	0x04, 0x70, 0x65, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x70, 0x65, 0x65,
	0x72, 0x12, 0x3f, 0x0a, 0x0f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x69,
	0x66, 0x69, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x72, 0x66, 0x71,
	...
	0x22, 0x99, 0x01, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x66, 0x71, 0x46, 0x6f, 0x72,
	0x77, 0x61, 0x72, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2e, 0x0a,
	0x08, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x12, 0x2e, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x66, 0x71, 0x46, 0x6f, 0x72, 0x77,
	0x61, 0x72, 0x64, 0x52, 0x08, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x1f, 0x0a,
	...
	,
	...
	0x58, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x6c, 0x6c, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x12, 0x20, 0x2e, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x64,
	0x64, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21, 0x2e, 0x72, 0x66, 0x71, 0x72, 0x70, 0x63, 0x2e,
	0x41, 0x64, 0x64, 0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x6c, 0x6c, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x58, 0x0a, 0x11, 0x41, 0x64, 0x64,
	0x41, 0x73, 0x73, 0x65, 0x74, 0x53, 0x65, 0x6c, 0x6c, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x12, 0x20,
	...
	,
...
var file_rfqrpc_rfq_proto_goTypes = []any{
	...
	(*QueryRfqForwardsRequest)(nil),         // 24: rfqrpc.QueryRfqForwardsRequest
	(*QueryRfqForwardsResponse)(nil),        // 25: rfqrpc.QueryRfqForwardsResponse
	(*RfqForward)(nil),                      // 26: rfqrpc.RfqForward
}
var file_rfqrpc_rfq_proto_depIdxs = []int32{
	...
	14, // 1: rfqrpc.AddAssetBuyOrderResponse.accepted_quote:type_name -> rfqrpc.PeerAcceptedBuyQuote
	16, // 2: rfqrpc.AddAssetBuyOrderResponse.invalid_quote:type_name -> rfqrpc.InvalidQuoteResponse
	17, // 3: rfqrpc.AddAssetBuyOrderResponse.rejected_quote:type_name -> rfqrpc.RejectedQuoteResponse
	2,  // 4: rfqrpc.AddAssetSellOrderRequest.asset_specifier:type_name -> rfqrpc.AssetSpecifier
	15, // 5: rfqrpc.AddAssetSellOrderResponse.accepted_quote:type_name -> rfqrpc.PeerAcceptedSellQuote
	16, // 6: rfqrpc.AddAssetSellOrderResponse.invalid_quote:type_name -> rfqrpc.InvalidQuoteResponse
	17, // 7: rfqrpc.AddAssetSellOrderResponse.rejected_quote:type_name -> rfqrpc.RejectedQuoteResponse
	2,  // 8: rfqrpc.AddAssetSellOfferRequest.asset_specifier:type_name -> rfqrpc.AssetSpecifier
	2,  // 9: rfqrpc.AddAssetBuyOfferRequest.asset_specifier:type_name -> rfqrpc.AssetSpecifier
	3,  // 10: rfqrpc.PeerAcceptedBuyQuote.ask_asset_rate:type_name -> rfqrpc.FixedPoint
	13, // 11: rfqrpc.PeerAcceptedBuyQuote.asset_spec:type_name -> rfqrpc.AssetSpec
	3,  // 12: rfqrpc.PeerAcceptedSellQuote.bid_asset_rate:type_name -> rfqrpc.FixedPoint
	13, // 13: rfqrpc.PeerAcceptedSellQuote.asset_spec:type_name -> rfqrpc.AssetSpec
	0,  // 14: rfqrpc.InvalidQuoteResponse.status:type_name -> rfqrpc.QuoteRespStatus
	14, // 15: rfqrpc.QueryPeerAcceptedQuotesResponse.buy_quotes:type_name -> rfqrpc.PeerAcceptedBuyQuote
	15, // 16: rfqrpc.QueryPeerAcceptedQuotesResponse.sell_quotes:type_name -> rfqrpc.PeerAcceptedSellQuote
	14, // 17: rfqrpc.PeerAcceptedBuyQuoteEvent.peer_accepted_buy_quote:type_name -> rfqrpc.PeerAcceptedBuyQuote
	15, // 18: rfqrpc.PeerAcceptedSellQuoteEvent.peer_accepted_sell_quote:type_name -> rfqrpc.PeerAcceptedSellQuote
	20, // 19: rfqrpc.RfqEvent.peer_accepted_buy_quote:type_name -> rfqrpc.PeerAcceptedBuyQuoteEvent
	21, // 20: rfqrpc.RfqEvent.peer_accepted_sell_quote:type_name -> rfqrpc.PeerAcceptedSellQuoteEvent
	22, // 21: rfqrpc.RfqEvent.accept_htlc:type_name -> rfqrpc.AcceptHtlcEvent
	2,  // 22: rfqrpc.QueryRfqForwardsRequest.asset_specifier:type_name -> rfqrpc.AssetSpecifier
	26, // 23: rfqrpc.QueryRfqForwardsResponse.forwards:type_name -> rfqrpc.RfqForward
	1,  // 24: rfqrpc.RfqForward.policy_type:type_name -> rfqrpc.RfqPolicyType
	13, // 25: rfqrpc.RfqForward.asset_spec:type_name -> rfqrpc.AssetSpec
	3,  // 26: rfqrpc.RfqForward.rate:type_name -> rfqrpc.FixedPoint
	4,  // 27: rfqrpc.Rfq.AddAssetBuyOrder:input_type -> rfqrpc.AddAssetBuyOrderRequest
	6,  // 28: rfqrpc.Rfq.AddAssetSellOrder:input_type -> rfqrpc.AddAssetSellOrderRequest
	8,  // 29: rfqrpc.Rfq.AddAssetSellOffer:input_type -> rfqrpc.AddAssetSellOfferRequest
	10, // 30: rfqrpc.Rfq.AddAssetBuyOffer:input_type -> rfqrpc.AddAssetBuyOfferRequest
	12, // 31: rfqrpc.Rfq.QueryPeerAcceptedQuotes:input_type -> rfqrpc.QueryPeerAcceptedQuotesRequest
	19, // 32: rfqrpc.Rfq.SubscribeRfqEventNtfns:input_type -> rfqrpc.SubscribeRfqEventNtfnsRequest
	24, // 33: rfqrpc.Rfq.QueryRfqForwards:input_type -> rfqrpc.QueryRfqForwardsRequest
	5,  // 34: rfqrpc.Rfq.AddAssetBuyOrder:output_type -> rfqrpc.AddAssetBuyOrderResponse
	7,  // 35: rfqrpc.Rfq.AddAssetSellOrder:output_type -> rfqrpc.AddAssetSellOrderResponse
	9,  // 36: rfqrpc.Rfq.AddAssetSellOffer:output_type -> rfqrpc.AddAssetSellOfferResponse
	11, // 37: rfqrpc.Rfq.AddAssetBuyOffer:output_type -> rfqrpc.AddAssetBuyOfferResponse
	18, // 38: rfqrpc.Rfq.QueryPeerAcceptedQuotes:output_type -> rfqrpc.QueryPeerAcceptedQuotesResponse
	23, // 39: rfqrpc.Rfq.SubscribeRfqEventNtfns:output_type -> rfqrpc.RfqEvent
	25, // 40: rfqrpc.Rfq.QueryRfqForwards:output_type -> rfqrpc.QueryRfqForwardsResponse
...
func file_rfqrpc_rfq_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rfqrpc_rfq_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*QueryRfqForwardsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rfqrpc_rfq_proto_msgTypes[23].Exporter = func(v any, i int) any {
			switch v := v.(*QueryRfqForwardsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

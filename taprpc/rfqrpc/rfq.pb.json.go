...
func RegisterRfqJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["rfqrpc.Rfq.AddAssetBuyOffer"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &AddAssetBuyOfferRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewRfqClient(conn)
		resp, err := client.AddAssetBuyOffer(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["rfqrpc.Rfq.QueryForwardingHistory"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &QueryForwardingHistoryRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewRfqClient(conn)
		resp, err := client.QueryForwardingHistory(ctx, req)
		if err != nil {
			callback("", err)
			return
		}

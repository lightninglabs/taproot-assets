...
func RegisterTaprootAssetsJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["taprpc.TaprootAssets.FetchAsset"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &FetchAssetRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewTaprootAssetsClient(conn)
		resp, err := client.FetchAsset(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["taprpc.TaprootAssets.ListAnchorings"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ListAnchoringsRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewTaprootAssetsClient(conn)
		resp, err := client.ListAnchorings(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["taprpc.TaprootAssets.WithdrawAnchoring"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &WithdrawAnchoringRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewTaprootAssetsClient(conn)
		resp, err := client.WithdrawAnchoring(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["taprpc.TaprootAssets.BakeMacaroon"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

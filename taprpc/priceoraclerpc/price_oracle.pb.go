...
type QueryRateTickRequest struct {
	...
	SubjectAsset *rfqrpc.AssetSpecifier `protobuf:"bytes,2,opt,name=subject_asset,json=subjectAsset,proto3" json:"subject_asset,omitempty"`
	...
	// unit
	PaymentAsset *rfqrpc.AssetSpecifier `protobuf:"bytes,4,opt,name=payment_asset,json=paymentAsset,proto3" json:"payment_asset,omitempty"`
...
func (x *QueryRateTickRequest) GetSubjectAsset() *rfqrpc.AssetSpecifier {
	if x != nil {
...
func (x *QueryRateTickRequest) GetPaymentAsset() *rfqrpc.AssetSpecifier {
	if x != nil {
...
var file_priceoraclerpc_price_oracle_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x49, 0x0a, 0x08, 0x52, 0x61, 0x74, 0x65, 0x54, 0x69, 0x63,
	0x6b, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x04, 0x72, 0x61, 0x74, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x5f,
	...
	0x22, 0xd5, 0x02, 0x0a, 0x14, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x61, 0x74, 0x65, 0x54, 0x69,
	...
	,
...
var file_priceoraclerpc_price_oracle_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_priceoraclerpc_price_oracle_proto_goTypes = []interface{}{
	...
	(*QueryRateTickRequest)(nil),         // 2: priceoraclerpc.QueryRateTickRequest
	(*QueryRateTickSuccessResponse)(nil), // 3: priceoraclerpc.QueryRateTickSuccessResponse
	(*QueryRateTickErrResponse)(nil),     // 4: priceoraclerpc.QueryRateTickErrResponse
	(*QueryRateTickResponse)(nil),        // 5: priceoraclerpc.QueryRateTickResponse
	(*rfqrpc.AssetSpecifier)(nil),        // 6: rfqrpc.AssetSpecifier
}
var file_priceoraclerpc_price_oracle_proto_depIdxs = []int32{
	...
	6, // 1: priceoraclerpc.QueryRateTickRequest.subject_asset:type_name -> rfqrpc.AssetSpecifier
	6, // 2: priceoraclerpc.QueryRateTickRequest.payment_asset:type_name -> rfqrpc.AssetSpecifier
	...
	3, // 5: priceoraclerpc.QueryRateTickResponse.success:type_name -> priceoraclerpc.QueryRateTickSuccessResponse
	4, // 6: priceoraclerpc.QueryRateTickResponse.error:type_name -> priceoraclerpc.QueryRateTickErrResponse
	2, // 7: priceoraclerpc.PriceOracle.QueryRateTick:input_type -> priceoraclerpc.QueryRateTickRequest
	5, // 8: priceoraclerpc.PriceOracle.QueryRateTick:output_type -> priceoraclerpc.QueryRateTickResponse
...
func file_priceoraclerpc_price_oracle_proto_init() {
	...
	file_priceoraclerpc_price_oracle_proto_msgTypes[4].OneofWrappers = []interface{}{

...
const (
	TaprootAssets_ListAssets_FullMethodName             = "/taprpc.TaprootAssets/ListAssets"
	TaprootAssets_ListUtxos_FullMethodName              = "/taprpc.TaprootAssets/ListUtxos"
	TaprootAssets_ListGroups_FullMethodName             = "/taprpc.TaprootAssets/ListGroups"
	TaprootAssets_ListBalances_FullMethodName           = "/taprpc.TaprootAssets/ListBalances"
	TaprootAssets_ListTransfers_FullMethodName          = "/taprpc.TaprootAssets/ListTransfers"
	TaprootAssets_StopDaemon_FullMethodName             = "/taprpc.TaprootAssets/StopDaemon"
	TaprootAssets_DebugLevel_FullMethodName             = "/taprpc.TaprootAssets/DebugLevel"
	TaprootAssets_QueryAddrs_FullMethodName             = "/taprpc.TaprootAssets/QueryAddrs"
	TaprootAssets_NewAddr_FullMethodName                = "/taprpc.TaprootAssets/NewAddr"
	TaprootAssets_DecodeAddr_FullMethodName             = "/taprpc.TaprootAssets/DecodeAddr"
	TaprootAssets_AddrReceives_FullMethodName           = "/taprpc.TaprootAssets/AddrReceives"
	TaprootAssets_VerifyProof_FullMethodName            = "/taprpc.TaprootAssets/VerifyProof"
	TaprootAssets_DecodeProof_FullMethodName            = "/taprpc.TaprootAssets/DecodeProof"
	TaprootAssets_ExportProof_FullMethodName            = "/taprpc.TaprootAssets/ExportProof"
	TaprootAssets_UnpackProofFile_FullMethodName        = "/taprpc.TaprootAssets/UnpackProofFile"
	TaprootAssets_SendAsset_FullMethodName              = "/taprpc.TaprootAssets/SendAsset"
	TaprootAssets_BurnAsset_FullMethodName              = "/taprpc.TaprootAssets/BurnAsset"
	TaprootAssets_ListBurns_FullMethodName              = "/taprpc.TaprootAssets/ListBurns"
	TaprootAssets_GetInfo_FullMethodName                = "/taprpc.TaprootAssets/GetInfo"
	TaprootAssets_FetchAssetMeta_FullMethodName         = "/taprpc.TaprootAssets/FetchAssetMeta"
	TaprootAssets_SubscribeReceiveEvents_FullMethodName = "/taprpc.TaprootAssets/SubscribeReceiveEvents"
	TaprootAssets_SubscribeSendEvents_FullMethodName    = "/taprpc.TaprootAssets/SubscribeSendEvents"
	TaprootAssets_RegisterTransfer_FullMethodName       = "/taprpc.TaprootAssets/RegisterTransfer"
)
...
type TaprootAssetsClient interface {
	...
	SubscribeReceiveEvents(ctx context.Context, in *SubscribeReceiveEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReceiveEvent], error)
	// tapcli: `events send`
	// SubscribeSendEvents allows a caller to subscribe to send events for outgoing
	// asset transfers.
	SubscribeSendEvents(ctx context.Context, in *SubscribeSendEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SendEvent], error)
...
func (c *taprootAssetsClient) ListAssets(ctx context.Context, in *ListAssetRequest, opts ...grpc.CallOption) (*ListAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_ListAssets_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) ListUtxos(ctx context.Context, in *ListUtxosRequest, opts ...grpc.CallOption) (*ListUtxosResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_ListUtxos_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) ListGroups(ctx context.Context, in *ListGroupsRequest, opts ...grpc.CallOption) (*ListGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_ListGroups_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) ListBalances(ctx context.Context, in *ListBalancesRequest, opts ...grpc.CallOption) (*ListBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_ListBalances_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) ListTransfers(ctx context.Context, in *ListTransfersRequest, opts ...grpc.CallOption) (*ListTransfersResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_ListTransfers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) StopDaemon(ctx context.Context, in *StopRequest, opts ...grpc.CallOption) (*StopResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_StopDaemon_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) DebugLevel(ctx context.Context, in *DebugLevelRequest, opts ...grpc.CallOption) (*DebugLevelResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_DebugLevel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) QueryAddrs(ctx context.Context, in *QueryAddrRequest, opts ...grpc.CallOption) (*QueryAddrResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_QueryAddrs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) NewAddr(ctx context.Context, in *NewAddrRequest, opts ...grpc.CallOption) (*Addr, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Addr)
	err := c.cc.Invoke(ctx, TaprootAssets_NewAddr_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) DecodeAddr(ctx context.Context, in *DecodeAddrRequest, opts ...grpc.CallOption) (*Addr, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Addr)
	err := c.cc.Invoke(ctx, TaprootAssets_DecodeAddr_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) AddrReceives(ctx context.Context, in *AddrReceivesRequest, opts ...grpc.CallOption) (*AddrReceivesResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_AddrReceives_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) VerifyProof(ctx context.Context, in *ProofFile, opts ...grpc.CallOption) (*VerifyProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_VerifyProof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) DecodeProof(ctx context.Context, in *DecodeProofRequest, opts ...grpc.CallOption) (*DecodeProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_DecodeProof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) ExportProof(ctx context.Context, in *ExportProofRequest, opts ...grpc.CallOption) (*ProofFile, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProofFile)
	err := c.cc.Invoke(ctx, TaprootAssets_ExportProof_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) UnpackProofFile(ctx context.Context, in *UnpackProofFileRequest, opts ...grpc.CallOption) (*UnpackProofFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_UnpackProofFile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) SendAsset(ctx context.Context, in *SendAssetRequest, opts ...grpc.CallOption) (*SendAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_SendAsset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) BurnAsset(ctx context.Context, in *BurnAssetRequest, opts ...grpc.CallOption) (*BurnAssetResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_BurnAsset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) ListBurns(ctx context.Context, in *ListBurnsRequest, opts ...grpc.CallOption) (*ListBurnsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_ListBurns_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) GetInfo(ctx context.Context, in *GetInfoRequest, opts ...grpc.CallOption) (*GetInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_GetInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) FetchAssetMeta(ctx context.Context, in *FetchAssetMetaRequest, opts ...grpc.CallOption) (*FetchAssetMetaResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_FetchAssetMeta_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootAssetsClient) SubscribeReceiveEvents(ctx context.Context, in *SubscribeReceiveEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReceiveEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaprootAssets_ServiceDesc.Streams[0], TaprootAssets_SubscribeReceiveEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeReceiveEventsRequest, ReceiveEvent]{ClientStream: stream}
...
type TaprootAssets_SubscribeReceiveEventsClient = grpc.ServerStreamingClient[ReceiveEvent]

func (c *taprootAssetsClient) SubscribeSendEvents(ctx context.Context, in *SubscribeSendEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SendEvent], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &TaprootAssets_ServiceDesc.Streams[1], TaprootAssets_SubscribeSendEvents_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeSendEventsRequest, SendEvent]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TaprootAssets_SubscribeSendEventsClient = grpc.ServerStreamingClient[SendEvent]
...
func (c *taprootAssetsClient) RegisterTransfer(ctx context.Context, in *RegisterTransferRequest, opts ...grpc.CallOption) (*RegisterTransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaprootAssets_RegisterTransfer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaprootAssetsServer interface {
	...
	// SubscribeReceiveEvents allows a caller to subscribe to receive events for
	// incoming asset transfers.
	SubscribeReceiveEvents(*SubscribeReceiveEventsRequest, grpc.ServerStreamingServer[ReceiveEvent]) error
	// tapcli: `events send`
	// SubscribeSendEvents allows a caller to subscribe to send events for outgoing
	// asset transfers.
	SubscribeSendEvents(*SubscribeSendEventsRequest, grpc.ServerStreamingServer[SendEvent]) error
	// RegisterTransfer informs the daemon about a new inbound transfer that has
	// happened. This is used for interactive transfers where no TAP address is
	// involved and the recipient is aware of the transfer through an out-of-band
	// protocol but the daemon hasn't been informed about the completion of the
...
// UnimplementedTaprootAssetsServer must be embedded to have
...
func (UnimplementedTaprootAssetsServer) SubscribeReceiveEvents(*SubscribeReceiveEventsRequest, grpc.ServerStreamingServer[ReceiveEvent]) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeReceiveEvents not implemented")
}
func (UnimplementedTaprootAssetsServer) SubscribeSendEvents(*SubscribeSendEventsRequest, grpc.ServerStreamingServer[SendEvent]) error {
...
func (UnimplementedTaprootAssetsServer) testEmbeddedByValue()                       {}
...
func RegisterTaprootAssetsServer(s grpc.ServiceRegistrar, srv TaprootAssetsServer) {
	// If the following call pancis, it indicates UnimplementedTaprootAssetsServer was
...
func _TaprootAssets_ListAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ListAssets_FullMethodName,
	}
...
func _TaprootAssets_ListUtxos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ListUtxos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_ListGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ListGroups_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_ListBalances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ListBalances_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_ListTransfers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ListTransfers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_StopDaemon_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_StopDaemon_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_DebugLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_DebugLevel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_QueryAddrs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_QueryAddrs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_NewAddr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_NewAddr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_DecodeAddr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_DecodeAddr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_AddrReceives_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_AddrReceives_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_VerifyProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_VerifyProof_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_DecodeProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_DecodeProof_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_ExportProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ExportProof_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_UnpackProofFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_UnpackProofFile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_SendAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_SendAsset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_BurnAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_BurnAsset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_ListBurns_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_ListBurns_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_GetInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_FetchAssetMeta_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_FetchAssetMeta_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TaprootAssets_SubscribeReceiveEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TaprootAssetsServer).SubscribeReceiveEvents(m, &grpc.GenericServerStream[SubscribeReceiveEventsRequest, ReceiveEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TaprootAssets_SubscribeReceiveEventsServer = grpc.ServerStreamingServer[ReceiveEvent]
...
func _TaprootAssets_SubscribeSendEvents_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(TaprootAssetsServer).SubscribeSendEvents(m, &grpc.GenericServerStream[SubscribeSendEventsRequest, SendEvent]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type TaprootAssets_SubscribeSendEventsServer = grpc.ServerStreamingServer[SendEvent]
...
func _TaprootAssets_RegisterTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaprootAssets_RegisterTransfer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

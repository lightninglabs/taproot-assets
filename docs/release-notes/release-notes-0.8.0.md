...
* [PR #1920](https://github.com/lightninglabs/taproot-assets/pull/1920) fixes
  a bug in which Neutrino-backed nodes could fail to import transfer
  proofs for remote-initiated force close transactions if they were not
  online to see them broadcast.

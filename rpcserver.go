...
func (r *rpcServer) GetInfo(context.Context, *taprpc.GetInfoRequest) (*taprpc.GetInfoResponse, error) {
	// Retrieve the best block's hash and height using ChainKit
	...
	// Retrieve the LND node info using GetInfo

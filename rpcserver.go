...
func (r *rpcServer) BurnAsset(ctx context.Context,
	...
	// TODO: Remove this switch once the deprecated asset field
	// is removed. Keep only the AssetSpecifier case.
	switch {
	case in.Asset != nil:
		...
		case errors.Is(err, address.ErrAssetGroupUnknown):
			...
			rpcsLog.Debug("Asset group key not found, asset " +
	...
	default:
		return nil, fmt.Errorf("either asset or asset_specifier " +
			"must be specified")
	}

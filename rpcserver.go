...
func (r *rpcServer) SignVirtualPsbt(_ context.Context,
	...
	err = r.cfg.AssetWallet.SignVirtualPacket(vPacket)
	if err != nil {
...
func (r *rpcServer) AnchorVirtualPsbts(ctx context.Context,
	...
	inputAsset := vPacket.Input.Asset()
	prevID := vPacket.Input.PrevID
	inputCommitment, err := r.cfg.AssetStore.FetchCommitment(
		ctx, inputAsset.ID(), prevID.OutPoint, inputAsset.Amount,
		inputAsset.GroupKey,
	)
	if err != nil {

...
func (m *MockProofArchive) ImportProofs(_ context.Context,
	_ VerifierCtx, _ bool, proofs ...*AnnotatedProof) error {
...
func newMockIgnoreChecker(ignoreAll bool, ignorePoints ...AssetPoint,
) *mockIgnoreChecker {

...
func (f *AssetWallet) FundPacket(ctx context.Context,
	...
	_, inputInclusionProof, err := assetInput.Commitment.Proof(
		assetInput.Asset.TaroCommitmentKey(),
	...
	vPkt.SetInputAsset(0, assetInput.Asset, inputInclusionProof)
...
func (f *AssetWallet) SignVirtualPacket(vPkt *taropsbt.VPacket) ([]uint32,
	...
	signedInputs := make([]uint32, 0, len(vPkt.Inputs))

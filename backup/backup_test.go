...
// newTestAssetBackup creates a complete test asset backup.
...
// TestWalletBackupRoundtrip tests encode/decode roundtrip for WalletBackup.
func TestWalletBackupRoundtrip(t *testing.T) {
	t.Parallel()
	...
	t.Logf("Encoded wallet backup size: %d bytes for %d assets",

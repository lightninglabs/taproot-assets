...
type Event struct {
	...
	// The map of asset ID to SendOutput that contains the amount and script
	// key of each asset output that was sent as part of the incoming asset
	// transfer.
...
func NewSourceFromWalletTx(addr *AddrWithKeyInfo,
	...
	outputs map[asset.ID]SendOutput) (EventSource, error) {
...
func NewSourceFromFragment(addr *AddrWithKeyInfo, block *wire.MsgBlock,
	fragment *proof.SendFragment) (EventSource, error) {

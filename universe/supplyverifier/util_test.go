...
func createTestRootCommitment(t *testing.T,
	...
	// Create a dummy commitment block.
...
func createTestValidMintEvent(t *testing.T, blockHeight uint32,
	...
	// Create a dummy block with our anchor transaction.
	block := wire.MsgBlock{
	...
	// Encode the proof into RawProof bytes.
	...
	// Create the issuance proof with valid RawProof.
	issuanceProof := universe.Leaf{
		GenesisWithGroup: universe.GenesisWithGroup{
			Genesis: assetGenesis,
		},

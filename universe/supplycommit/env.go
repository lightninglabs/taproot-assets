...
// FetchSupplyLeavesResp is the response type for fetching the supply
// leaves for a given asset specifier.
type FetchSupplyLeavesResp struct {
...
type SupplyTreeView interface {
	...
	FetchSupplyLeavesByHeight(ctx context.Context,
		...
		endHeight uint32) lfn.Result[FetchSupplyLeavesResp]
}

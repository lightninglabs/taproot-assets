...
type Querier interface {
	...
	QueryFederationGlobalSyncConfig(ctx context.Context) ([]FederationGlobalSyncConfig, error)
	...
	SetFederationGlobalSyncConfig(ctx context.Context, arg SetFederationGlobalSyncConfigParams) error

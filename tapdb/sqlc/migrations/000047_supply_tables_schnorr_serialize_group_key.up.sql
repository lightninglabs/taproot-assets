...
-- mint_supply_pre_commits (depends on supply_commitments).
...
-- supply_pre_commits (depends on supply_commitments).
...
-------------------------------------------------------------------------------
-- Recreate tables and indexes with 32-byte group_key where applicable.
-------------------------------------------------------------------------------

-- Recreate universe_supply_roots with updated group_key field (32 bytes instead of 33).
...
-- Recreate supply_syncer_push_log with updated group_key field (32 bytes instead of 33).
...
-- Recreate supply_commitments with updated group_key field (32 bytes instead of 33).
...
-- Recreate supply_commit_state_machines with updated group_key field (32 bytes instead of 33).
...
-- Recreate supply_commit_transitions (references both commitments and state machines).
...
-- Recreate supply_update_events with updated group_key field (32 bytes instead of 33).
...
-- Recreate mint_supply_pre_commits with updated group_key field (32 bytes instead of 33).
...
-- Recreate supply_pre_commits with updated group_key field (32 bytes).

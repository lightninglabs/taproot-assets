-- Most impactful for query_asset_stats which currently has the highest latency
...
-- Helps with the join conditions we frequently see. This is especially useful
-- for query_universe_leaves and improves join efficiency.

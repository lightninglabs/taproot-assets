-- Revert rfq_policies CHECK constraint to original (remove peer-accepted buy).
-- First delete any peer-accepted buy rows, then recreate original schema.
-- Must also handle the forwards table FK reference.

DELETE FROM rfq_policies WHERE policy_type = 'RFQ_POLICY_TYPE_PEER_ACCEPTED_BUY';
...
-- 2. Rename and recreate rfq_policies with original CHECK constraint.
...
INSERT INTO rfq_policies (
    ...
    payment_max_msat, request_asset_max_amt, request_payment_max_msat,

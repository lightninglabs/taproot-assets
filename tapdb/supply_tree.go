...
func fetchSupplyLeavesByHeight(ctx context.Context, db BaseUniverseStore,
	...
	endHeight uint32) (*supplycommit.FetchSupplyLeavesResp, error) {
	...
	var resp supplycommit.FetchSupplyLeavesResp
...
func (s *SupplyTreeStore) FetchSupplyLeavesByHeight(ctx context.Context,
	...
	endHeight uint32) lfn.Result[supplycommit.FetchSupplyLeavesResp] {

	type respType = supplycommit.FetchSupplyLeavesResp
